...
SWEP.Sounds = {
	...
	base_reload = {
		{time = 25/30, sound = "CW_KK_INS2_AK74_MAGRELEASE"},
		{time = 29/30, sound = "CW_KK_INS2_AK74_MAGOUT"},
		{time = 38/30, sound = "CW_KK_INS2_AK74_MAGOUTRATTLE"},
		{time = 56/30, sound = "CW_KK_INS2_AK74_MAGIN"},
	...
	base_reloadempty = {
		...
		{time = 80/30, sound = "CW_KK_INS2_AK74_RATTLE"},
		{time = 90/30, sound = "CW_KK_INS2_AK74_BOLTBACK"},
