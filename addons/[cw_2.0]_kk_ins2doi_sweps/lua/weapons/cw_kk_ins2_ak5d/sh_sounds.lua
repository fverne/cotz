CustomizableWeaponry:addFireSound("CW_KK_INS2_AK5D_FIRE", "weapons/ak5d/ak5d_fp.wav")
CustomizableWeaponry:addFireSound("CW_KK_INS2_AK5D_FIRE_SUPPRESSED", "weapons/ak5d/ak5d_suppressed_fp.wav")
