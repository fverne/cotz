...
if CLIENT then
	...
	SWEP.AttachmentModelsVM = {
		...
		["handguardStandard"] = {model = "models/weapons/upgrades/a_standard_ak74.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, active = true},
	...
	SWEP.AttachmentModelsWM = {
		...
		["handguardStandard"] = {model = "models/weapons/upgrades/w_standard_ak74.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, active = true},

		["kk_ins2_pbs5"] = {model = "models/weapons/upgrades/w_sil_ins1.mdl", pos = Vector(-36.25,0,11.9), angle = Angle(), size = Vector(1, 1, 1), attachment = "silencer"},
		...
		["kk_ins2_lam"] = {model = "models/weapons/upgrades/w_laser_ins.mdl", pos = Vector(0,-1.03,8.3), angle = Angle(0,180,180), size = Vector(1, 1, 1), attachment = "laser"},
		["kk_ins2_flashlight"] = {model = "models/weapons/upgrades/w_laser_ins.mdl", pos = Vector(0,-1.03,8.3), angle = Angle(0,180,180), size = Vector(1, 1, 1), attachment = "laser"},
...
SWEP.ViewModel		= "models/weapons/ethereal/v_ak74.mdl"
SWEP.WorldModel		= "models/weapons/ethereal/w_ak74.mdl"

SWEP.WMPos = Vector(4.266, 0.90, -1.255)
