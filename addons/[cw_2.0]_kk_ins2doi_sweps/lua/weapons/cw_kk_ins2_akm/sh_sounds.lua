CustomizableWeaponry:addFireSound("CW_KK_INS2_AKM_FIRE", "weapons/ak47/ak47_fp.wav")
CustomizableWeaponry:addFireSound("CW_KK_INS2_AKM_FIRE_SUPPRESSED", "weapons/ak47/ak47_suppressed_fp.wav")
