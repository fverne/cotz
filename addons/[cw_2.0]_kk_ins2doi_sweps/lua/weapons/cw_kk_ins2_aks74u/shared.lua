...
if CLIENT then
	...
	SWEP.AttachmentModelsVM = {
		["kk_ins2_optic_rail"] = {model = "models/weapons/upgrades/a_modkit_07.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},
		["handguardStandard"] = {model = "models/weapons/upgrades/a_standard_aks74u.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, active = true},

		["kk_ins2_pbs5"] = {model = "models/weapons/upgrades/a_suppressor_aks.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},

		["kk_ins2_vertgrip"] = {model = "models/weapons/upgrades/a_woodgrips_aks74u.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},
	...
	SWEP.AttachmentModelsWM = {
		...
		["kk_ins2_pbs5"] = {model = "models/weapons/upgrades/w_sil_ins1.mdl", pos = Vector(-35.2,0,11.8), angle = Angle(), size = Vector(1, 1, 1), attachment = "silencer"},
		...
		["kk_ins2_lam"] = {model = "models/weapons/upgrades/w_laser_ins.mdl", pos = Vector(-2.5,0,8.7), angle = Angle(0,180,180), size = Vector(1, 1, 1), attachment = "laser"},
		["kk_ins2_flashlight"] = {model = "models/weapons/upgrades/w_laser_ins.mdl", pos = Vector(-2.5,0,8.7), angle = Angle(0,180,180), size = Vector(1, 1, 1), attachment = "laser"},
...
SWEP.ViewModel		= "models/weapons/ethereal/v_aks74u.mdl"
SWEP.WorldModel		= "models/weapons/ethereal/w_aks74u.mdl"

SWEP.WMPos =Vector(4.524, 0.96, -1.188)
