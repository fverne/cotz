...
SWEP.Sounds = {
	...
	base_reload = {
		...
		{time = 61/30, sound = "CW_KK_INS2_M4A1_MAGIN"},
	},

	base_reloadempty = {
		{time = 18/30, sound = "CW_KK_INS2_M4A1_MAGRELEASE"},
		{time = 20/30, sound = "CW_KK_INS2_M4A1_MAGOUT"},
		{time = 69/30, sound = "CW_KK_INS2_M4A1_MAGIN"},
		{time = 96/30, sound = "CW_KK_INS2_M4A1_BOLTBACK"},
		{time = 105/30, sound = "CW_KK_INS2_M4A1_BOLTRELEASE"},
	},
