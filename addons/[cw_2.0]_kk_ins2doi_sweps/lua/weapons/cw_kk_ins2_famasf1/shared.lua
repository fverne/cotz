...
if CLIENT then
	...
	SWEP.AttachmentModelsWM = {
		["kk_ins2_suppressor_sec"] = {model = "models/weapons/upgrades/w_sil_sec1.mdl", pos = Vector(-36,-0.05,6.8), angle = Angle(), size = Vector(1, 1, 1), attachment = "silencer"},
	...
	SWEP.KKINS2KobraPos = Vector(-2.6006, -2, -1.6304)
	SWEP.KKINS2KobraAng = Vector()

	SWEP.KKINS2EoTechPos = Vector(-2.6006, -2, -1.3804)
	SWEP.KKINS2EoTechAng = Vector()

	SWEP.KKINS2AimpointPos = Vector(-2.6006, -2, -1.3804)
	SWEP.KKINS2AimpointAng = Vector()

	SWEP.KKINS2ElcanPos = Vector(-2.6006, -3, -1.4804)
	SWEP.KKINS2ElcanAng = Vector(0,-0.1,0)

	SWEP.KKINS2PO4Pos = Vector(-2.5006, -3, -1.2304)
	SWEP.KKINS2PO4Ang = Vector(0,-0.1,0)

	SWEP.KKINS2MagnifierPos = Vector(-2.6006, -3, -1.3804)
	SWEP.KKINS2MagnifierAng = Vector(0,-0.1,0)
--------------------------------------------------------------
	SWEP.KKINS2CSTMCMorePos = Vector(-2.6006, -2, -1.3804)
	SWEP.KKINS2CSTMCMoreAng = Vector()

	SWEP.KKINS2CSTMBarskaPos = Vector(-2.6006, -2, -1.3804)
	SWEP.KKINS2CSTMBarskaAng = Vector()

	SWEP.KKINS2CSTMMicroT1Pos = Vector(-2.6006, -2, -1.4504)
	SWEP.KKINS2CSTMMicroT1Ang = Vector()

	SWEP.KKINS2CSTMEoTechXPSPos = Vector(-2.6006, -2, -1.3804)
	SWEP.KKINS2CSTMEoTechXPSAng = Vector()

	SWEP.KKINS2CSTMCompM4SPos = Vector(-2.6006, -2, -1.3804)
	SWEP.KKINS2CSTMCompM4SAng = Vector()

	SWEP.KKINS2CSTMACOGPos = Vector(-2.6006, -3, -1.3804)
	SWEP.KKINS2CSTMACOGAng = Vector(0,-0.1,0)
end
...
SWEP.ViewModel		= "models/weapons/ethereal/v_famasf1.mdl"
SWEP.WorldModel		= "models/weapons/ethereal/w_famasf1.mdl"

SWEP.WMPos = Vector(4.819, 0.854, -1.293)
...
SWEP.FireSound = "CW_KK_INS2_FAMAS_FIRE"
SWEP.FireSoundSuppressed = "CW_KK_INS2_FAMAS_FIRE_SUPPRESSED"
SWEP.Recoil = 0.9975
