...
if CLIENT then
	...
	SWEP.AttachmentModelsVM = {
		...
		["kk_ins2_optic_iron"] = {model = "models/weapons/ethereal/upgrades/a_carryhandle_sca.mdl", pos = Vector(-1.867,1.315,-9), angle = Angle(89,90,0), size = Vector(.6, .8, .8), bone = "A_Optic", active = true},
	...
	SWEP.AttachmentModelsWM = {
		["kk_ins2_suppressor_sec"] = {model = "models/weapons/upgrades/w_sil_sec2.mdl", pos = Vector(-33,-4,-0.25), angle = Angle(0,0,-90), size = Vector(1, 1, 1), attachment = "silencer"},

		["kk_ins2_vertgrip"] = {model = "models/weapons/upgrades/w_foregrip_sec1.mdl", pos = Vector(9.3,0,0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), bone = "A_Foregrip"},

		["kk_ins2_lam"] = {model = "models/weapons/upgrades/w_laser_sec.mdl", pos = Vector(0,-0.4,8.9), angle = Angle(0,180,180), size = Vector(1, 1, 1), attachment = "laser"},
		["kk_ins2_flashlight"] = {model = "models/weapons/upgrades/w_laser_sec.mdl", pos = Vector(0,-0.4,8.9), angle = Angle(0,180,180), size = Vector(1, 1, 1), attachment = "laser"},
	...
	SWEP.IronsightPos = Vector(-2.610, -3, -0.3635)
	SWEP.IronsightAng = Vector(1, 0.0105, 0)

	SWEP.KKINS2KobraPos = Vector(-2.610, -1, -0.3835)
	SWEP.KKINS2KobraAng = Vector()

	SWEP.KKINS2EoTechPos = Vector(-2.610, -1, -0.5535)
	SWEP.KKINS2EoTechAng = Vector()

	SWEP.KKINS2AimpointPos = Vector(-2.610, -2, -0.3235)
	SWEP.KKINS2AimpointAng = Vector()

	SWEP.KKINS2ElcanPos = Vector(-2.610, -3, -0.7135)
	SWEP.KKINS2ElcanAng = Vector()

	SWEP.KKINS2PO4Pos = Vector(-2.5410, -4.5, -0.2635)
	SWEP.KKINS2PO4Ang = Vector()

	SWEP.KKINS2MagnifierPos = Vector(-2.5910, -5, -0.3635)
	SWEP.KKINS2MagnifierAng = Vector()

	SWEP.KKINS2CSTMEoTechXPSPos = Vector(-2.610, -2, -0.3035)
	SWEP.KKINS2CSTMEoTechXPSAng = Vector()
	
	SWEP.KKINS2CSTMPGO7Pos = Vector(-0.8964, -3, -0.5)
	SWEP.KKINS2CSTMPGO7Ang = Vector()

	SWEP.KKINS2CSTMACOGPos = Vector(-2.610, -4, -0.7135)
	SWEP.KKINS2CSTMACOGAng = Vector()

	SWEP.KKINS2CSTMCMorePos = Vector(-2.610, -2, -0.3235)
	SWEP.KKINS2CSTMCMoreAng = Vector()

	SWEP.KKINS2CSTMBarskaPos = Vector(-2.610, -2, -0.5535)
	SWEP.KKINS2CSTMBarskaAng = Vector()

	SWEP.KKINS2CSTMMicroT1Pos = Vector(-2.610, -2, -0.3235)
	SWEP.KKINS2CSTMMicroT1Ang = Vector()

	SWEP.KKINS2CSTMCompM4SPos = Vector(-2.610, -2, -0.3235)
...
SWEP.Animations = {
	...
	base_draw = "base_draw",
	base_fire = "base_fire",
	base_fire_aim = {"iron_fire_a", "iron_fire_b", "iron_fire_c", "iron_fire_d", "iron_fire_e", "iron_fire_f", "iron_fire_g"},
	...
	foregrip_fire_aim = {"foregrip_iron_fire_a", "foregrip_iron_fire_b", "foregrip_iron_fire_c", "foregrip_iron_fire_d", "foregrip_iron_fire_e", "foregrip_iron_fire_f", "foregrip_iron_fire_g"},
...
SWEP.ViewModel		= "models/weapons/ethereal/v_fnf2000.mdl"
SWEP.WorldModel		= "models/weapons/ethereal/w_fnf2000.mdl"

SWEP.WMPos = Vector(3.418, 0.911, -0.543)
...
SWEP.FireSound = "CW_KK_INS2_FN2K_FIRE"
SWEP.FireSoundSuppressed = "CW_KK_INS2_FN2K_FIRE_SUPPRESSED"
SWEP.Recoil = 1.1025
