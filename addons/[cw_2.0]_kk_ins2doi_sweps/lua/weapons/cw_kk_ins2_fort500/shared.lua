...
if CLIENT then
	...
	SWEP.AttachmentModelsWM = {
		...
		["kk_ins2_suppressor_shotgun"] = {model = "models/weapons/upgrades/w_sil_pistol.mdl", pos = Vector(-34.3,9.4,0), angle = Angle(0,0,90), size = Vector(1, 1, 1), attachment = "silencer"},

		["kk_ins2_vertgrip"] = {model = "models/weapons/upgrades/w_foregrip_sec2.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},

		["kk_ins2_lam"] = {model = "models/weapons/upgrades/w_laser_ins.mdl", pos = Vector(-1.3,8.5,0), angle = Angle(0,180,90), size = Vector(1, 1, 1), attachment = "laser"},
		["kk_ins2_flashlight"] = {model = "models/weapons/upgrades/w_laser_ins.mdl", pos = Vector(-1.3,8.5,0), angle = Angle(0,180,90), size = Vector(1, 1, 1), attachment = "laser"},
	...
	SWEP.IronsightPos = Vector(-2.004, -2, 0.72)
	SWEP.IronsightAng = Vector(0, 0.06, 0)

	SWEP.KKINS2KobraPos = Vector(-2.0135, -1, -0.2049)
	SWEP.KKINS2KobraAng = Vector()

	SWEP.KKINS2EoTechPos = Vector(-2.0188, -1, -0.147)
	SWEP.KKINS2EoTechAng = Vector()

	SWEP.KKINS2AimpointPos = Vector(-2.004, -1, -0.165)
...
SWEP.ViewModel		= "models/weapons/ethereal/v_fort500.mdl"
SWEP.WorldModel		= "models/weapons/ethereal/w_fort500.mdl"

SWEP.WMPos = Vector(4.963, 0.535, -2.945)
