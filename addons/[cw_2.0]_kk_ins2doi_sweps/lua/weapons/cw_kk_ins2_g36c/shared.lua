...
if CLIENT then
	...
	SWEP.AttachmentModelsWM = {
		...
		["kk_ins2_vertgrip"] = {model = "models/weapons/upgrades/w_foregrip_sec1.mdl", pos = Vector(10,0,1.75), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), bone = "A_Foregrip"},
		
		["kk_ins2_lam"] = {model = "models/weapons/upgrades/w_laser_sec.mdl", pos = Vector(-1.4,-9.2,0), angle = Angle(180,0,90), size = Vector(1, 1, 1), attachment = "laser"},
		["kk_ins2_flashlight"] = {model = "models/weapons/upgrades/w_laser_sec.mdl", pos = Vector(-1.4,-9.2,0), angle = Angle(180,0,90), size = Vector(1, 1, 1), attachment = "laser"},
	...
	SWEP.IronsightPos = Vector(-2.810, -1, 0.7035)
	SWEP.IronsightAng = Vector()

	SWEP.KKINS2PO4Pos = Vector(-2.720, 0, -0.185)
	SWEP.KKINS2PO4Ang = Vector()

	SWEP.KKINS2EoTechPos = Vector(-2.810, -1, -0.2885)
	SWEP.KKINS2EoTechAng = Vector()

	SWEP.KKINS2AimpointPos = Vector(-2.810, -1, -0.2885)
	SWEP.KKINS2AimpointAng = Vector()

	SWEP.KKINS2KobraPos = Vector(-2.810, 0, -0.485)
	SWEP.KKINS2KobraAng = Vector()

	SWEP.KKINS2ElcanPos = Vector(-2.810, -1, -0.408)
	SWEP.KKINS2ElcanAng = Vector()

	SWEP.KKINS2MagnifierPos = Vector(-2.810, -1, -0.2885)
	SWEP.KKINS2MagnifierAng = Vector()
	
	SWEP.KKINS2CSTMCMorePos = Vector(-2.810, -1, -0.2885)
	SWEP.KKINS2CSTMCMoreAng = Vector()

	SWEP.KKINS2CSTMBarskaPos = Vector(-2.810, -1, -0.2885)
	SWEP.KKINS2CSTMBarskaAng = Vector()

	SWEP.KKINS2CSTMMicroT1Pos = Vector(-2.810, -1, -0.3185)
	SWEP.KKINS2CSTMMicroT1Ang = Vector()

	SWEP.KKINS2CSTMEoTechXPSPos = Vector(-2.810, -1, -0.2885)
	SWEP.KKINS2CSTMEoTechXPSAng = Vector()

	SWEP.KKINS2CSTMCompM4SPos = Vector(-2.810, -1, -0.2885)
	SWEP.KKINS2CSTMCompM4SAng = Vector()

	SWEP.KKINS2CSTMACOGPos = Vector(-2.780, -1, -0.4085)
...
SWEP.ViewModel		= "models/weapons/ethereal/v_g36c.mdl"
SWEP.WorldModel		= "models/weapons/ethereal/w_g36c.mdl"

SWEP.WMPos = Vector(5.019, 1.354, -1.093)
