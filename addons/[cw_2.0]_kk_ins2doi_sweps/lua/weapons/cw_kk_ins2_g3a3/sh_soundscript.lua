...
SWEP.Sounds = {
	...
	base_reloadempty = {
		{time = 11/30, sound = "CW_KK_INS2_FNFAL_BOLTBACK"},
		{time = 35/30, sound = "CW_KK_INS2_FNFAL_MAGRELEASE"},
		{time = 38/30, sound = "CW_KK_INS2_FNFAL_MAGOUT"},
		{time = 39/30, sound = "CW_KK_INS2_FNFAL_MAGOUTRATTLE"},
		{time = 87/30, sound = "CW_KK_INS2_FNFAL_MAGIN"},
		{time = 90/30, sound = "CW_KK_INS2_FNFAL_RATTLE"},
		{time = 114/30, sound = "CW_KK_INS2_FNFAL_BOLTRELEASE"},
	},
