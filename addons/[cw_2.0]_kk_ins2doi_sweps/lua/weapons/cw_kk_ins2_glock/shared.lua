...
if CLIENT then
	...
	SWEP.AttachmentModelsWM = {
		...
		["kk_ins2_lam"] = {model = "models/weapons/upgrades/w_laser_sec.mdl", pos = Vector(0,7.6), angle = Angle(0, 180, 90), size = Vector(1, 1, 1), attachment = "laser"},
		["kk_ins2_flashlight"] = {model = "models/weapons/upgrades/w_laser_sec.mdl", pos = Vector(0,7.6), angle = Angle(0, 180, 90), size = Vector(1, 1, 1), attachment = "laser"},
	}

	SWEP.IronsightPos = Vector(-1.9821, 0, 0.6234)
	SWEP.IronsightAng = Vector(0.6, 0.00, 0)
...
SWEP.ViewModel		= "models/weapons/ethereal/v_glock.mdl"
SWEP.WorldModel		= "models/weapons/ethereal/w_glock.mdl"

SWEP.WMPos = Vector(4.109, 1.423, -1.421)
