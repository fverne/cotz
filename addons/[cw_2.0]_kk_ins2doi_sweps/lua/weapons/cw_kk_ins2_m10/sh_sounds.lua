CustomizableWeaponry:addFireSound("CW_KK_INS2_REVOLVER_FIRE", "weapons/revolver/revolver_fp.wav")
CustomizableWeaponry:addFireSound("CW_KK_INS2_REVOLVER_FIRE_SUPPRESSED", "weapons/revolver/revolver_fp.wav")
