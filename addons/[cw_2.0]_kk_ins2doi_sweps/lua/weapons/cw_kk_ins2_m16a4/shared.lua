...
if CLIENT then
	...
	SWEP.AttachmentModelsWM = {
		...
		["kk_ins2_suppressor_sec"] = {model = "models/weapons/upgrades/w_sil_sec1.mdl", pos = Vector(-34.9,-0.075,6.8), angle = Angle(), size = Vector(1, 1, 1), attachment = "silencer"},
...
SWEP.ViewModel		= "models/weapons/ethereal/v_m16a3.mdl"
SWEP.WorldModel		= "models/weapons/ethereal/w_m16.mdl"

SWEP.WMPos = Vector(4.619, 1.054, -0.993)
