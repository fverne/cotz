...
if CLIENT then
	...
	SWEP.AttachmentModelsWM = {
		["kk_ins2_suppressor_sec"] = {model = "models/weapons/upgrades/w_sil_pistol.mdl", pos = Vector(-35.7,-0.05,9.26), angle = Angle(), size = Vector(1, 1, 1), attachment = "silencer"},
...
SWEP.ViewModel		= "models/weapons/ethereal/v_m249.mdl"
SWEP.WorldModel		= "models/weapons/ethereal/w_m249.mdl"

SWEP.WMPos = Vector(4.684, 0.935, -1.33)
