...
SWEP.Sounds = {
	base_ready = {
		...
		{time = 26/30, sound = "CW_KK_INS2_M4A1CHAN_BOLTRELEASE"},
	},
	...
	base_dryfire = {
		{time = 0/30, sound = "CW_KK_INS2_M4A1CHAN_EMPTY"},
	},
	...
	base_reload = {
		...
		{time = 17/30, sound = "CW_KK_INS2_M4A1CHAN_MAGOUT"},
		{time = 71/30, sound = "CW_KK_INS2_M4A1CHAN_MAGIN"},
		{time = 87/30, sound = "CW_KK_INS2_M4A1CHAN_HIT"},
	},
	...
	base_reloadempty = {
		...
		{time = 71/30, sound = "CW_KK_INS2_M4A1CHAN_MAGIN"},
		{time = 87/30, sound = "CW_KK_INS2_M4A1CHAN_HIT"},
		{time = 112/30, sound = "CW_KK_INS2_M4A1CHAN_BOLTRELEASE"},
	},
