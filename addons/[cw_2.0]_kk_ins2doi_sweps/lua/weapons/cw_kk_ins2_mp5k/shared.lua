...
if CLIENT then
	...
	SWEP.AttachmentModelsWM = {
		...
		["kk_ins2_suppressor_sec"] = {model = "models/weapons/upgrades/w_sil_sec1.mdl", pos = Vector(-32.35,7,0), angle = Angle(0,0,90), size = Vector(1, 1, 1), attachment = "silencer"},

		["kk_ins2_lam"] = {model = "models/weapons/upgrades/w_laser_sec.mdl", pos = Vector(-0.6,-0.6,8.4), angle = Angle(180,0,0), size = Vector(1, 1, 1), attachment = "laser"},
		["kk_ins2_flashlight"] = {model = "models/weapons/upgrades/w_laser_sec.mdl", pos = Vector(-0.6,-0.6,8.4), angle = Angle(180,0,0), size = Vector(1, 1, 1), attachment = "laser"},
...
SWEP.ViewModel		= "models/weapons/ethereal/v_mp5kpdw.mdl"
SWEP.WorldModel		= "models/weapons/ethereal/w_mp5k.mdl"

SWEP.WMPos = Vector(4.071, 1.467, -1.244)
