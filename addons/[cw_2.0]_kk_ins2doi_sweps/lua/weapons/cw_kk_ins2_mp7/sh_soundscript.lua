...
SWEP.Sounds = {
	...
	base_reload = {
		...
		{time = 58/30, sound = "CW_KK_INS2_MP5K_MAGIN"},
	},

	base_reloadempty = {
		{time = 10/30, sound = "CW_KK_INS2_MP5K_MAGRELEASE"},
		{time = 17/30, sound = "CW_KK_INS2_MP5K_MAGOUT"},
		{time = 58/30, sound = "CW_KK_INS2_MP5K_MAGIN"},
		{time = 94/30, sound = "CW_KK_INS2_MP5K_BOLTLOCK"},
		{time = 99/30, sound = "CW_KK_INS2_MP5K_BOLTRELEASE"},
	},
