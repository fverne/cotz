...
if CLIENT then
	...
	SWEP.AttachmentModelsWM = {
		...
		["kk_ins2_lam"] = {model = "models/weapons/upgrades/w_laser_sec.mdl", pos = Vector(1.11,7.9,0), angle = Angle(0, 180, 90), size = Vector(1, 1, 1), attachment = "laser"},
		["kk_ins2_flashlight"] = {model = "models/weapons/upgrades/w_laser_sec.mdl", pos = Vector(1.11,7.9,0), angle = Angle(0, 180, 90), size = Vector(1, 1, 1), attachment = "laser"},
	}

	SWEP.IronsightPos = Vector(-2.7521, 0, 0.3034)
...
SWEP.ViewModel		= "models/weapons/ethereal/v_p99.mdl"
SWEP.WorldModel		= "models/weapons/ethereal/w_p99.mdl"

SWEP.WMPos = Vector(3.909, 1.323, -1.821)
