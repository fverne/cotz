...
if CLIENT then
	...
	SWEP.AttachmentModelsVM = {
		["kk_ins2_optic_iron"] = {model = "models/weapons/ethereal/upgrades/a_carryhandle_sca.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, active = true},
		...
		["cover_short"] = {model = "models/weapons/ethereal/upgrades/a_standard2_scar_.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},
		["cover_long"] = {model = "models/weapons/ethereal/upgrades/a_standard_scar_.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, active = true},
	...
	SWEP.AttachmentModelsWM = {
		...
		["kk_ins2_suppressor_sec"] = {model = "models/weapons/upgrades/w_sil_sec1.mdl", pos = Vector(-34.2,-6.8,0), angle = Angle(0,0,-90), size = Vector(1, 1, 1), attachment = "silencer"},
		
		["kk_ins2_bipod"] = {model = "models/weapons/upgrades/w_bipod_m40.mdl", pos = Vector(-21.5,1.3,0), angle = Angle(0,0,-90), size = Vector(1, 1, 1), attachment = "bipod"},
		...
		["kk_ins2_lam"] = {model = "models/weapons/upgrades/w_laser_sec.mdl", pos = Vector(0,9.4,0), angle = Angle(180,0,-90), size = Vector(1, 1, 1), attachment = "laser"},
		["kk_ins2_flashlight"] = {model = "models/weapons/upgrades/w_laser_sec.mdl", pos = Vector(0,9.4,0), angle = Angle(180,0,-90), size = Vector(1, 1, 1), attachment = "laser"},
	...
	SWEP.IronsightPos = Vector(-2.485, -2, 0.334)
	SWEP.IronsightAng = Vector(-0.0, 0.0, 0)

	SWEP.FoldSightPos = Vector(-2.4932, -2, 0.9581)
	SWEP.FoldSightAng = Vector(-0.8694, 0.0447, 0)

	SWEP.M203Pos = Vector(-1.15, -1.75, 2.15)
	SWEP.M203Ang = Vector(-1.85, 0.0, 0)

	SWEP.KKINS2KobraPos = Vector(-2.4973, -2, -0.06)
	SWEP.KKINS2KobraAng = Vector()

	SWEP.KKINS2EoTechPos = Vector(-2.4952, -2, 0.134)
	SWEP.KKINS2EoTechAng = Vector()

	SWEP.KKINS2AimpointPos = Vector(-2.4968, -2, 0.134)
	SWEP.KKINS2AimpointAng = Vector()

	SWEP.KKINS2ElcanPos = Vector(-2.4906, -2, 0.05)
	SWEP.KKINS2ElcanAng = Vector()

	SWEP.KKINS2PO4Pos = Vector(-2.42, -2, 0.3)
	SWEP.KKINS2PO4Ang = Vector()

	SWEP.KKINS2ScopeM40Pos = Vector(-2.4932, 0, 0.275)
	SWEP.KKINS2ScopeM40Ang = Vector(0, 0.0, 0)

	SWEP.KKINS2MagnifierPos = Vector(-2.4968, -2, 0.134)
...
SWEP.Attachments = {
	{header = "Sight", offset = {500, -500}, atts = {"kk_ins2_kobra", "kk_ins2_eotech", "kk_ins2_aimpoint", "kk_ins2_elcan", "kk_ins2_po4", "kk_ins2_scope_m40", "kk_ins2_cstm_cmore", "kk_ins2_cstm_barska", "kk_ins2_cstm_microt1", "kk_ins2_cstm_eotechxps", "kk_ins2_cstm_compm4s", "kk_ins2_cstm_acog"}},
...
SWEP.ViewModel		= "models/weapons/ethereal/v_scar_.mdl"
SWEP.WorldModel		= "models/weapons/ethereal/w_sca.mdl"

SWEP.WMPos = Vector(4.519, 1.054, -1.193)
...
SWEP.FireSound = "CW_JK_INS2_SCAR_FIRE"
SWEP.FireSoundSuppressed = "CW_JK_INS2_SCAR_SUP"
SWEP.Recoil = 1.1025
