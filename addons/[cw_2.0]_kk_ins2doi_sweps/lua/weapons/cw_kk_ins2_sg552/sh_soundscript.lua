...
SWEP.Sounds = {
	base_ready = {
		...
		{time = 13/30, sound = "CW_KK_INS2_MINI14_BOLTBACK"},
	...
	base_reloadempty = {
		...
		{time = 23/30, sound = "CW_KK_INS2_MINI14_MAGOUT"},
		{time = 63/30, sound = "CW_KK_INS2_MINI14_MAGIN"},
		{time = 90/30, sound = "CW_KK_INS2_MINI14_BOLTBACK"},
		{time = 96/30, sound = "CW_KK_INS2_MINI14_BOLTRELEASE"},
	},
	...
	foregrip_ready = {
		{time = 0, sound = "CW_KK_INS2_UNIVERSAL_DRAW"},
		{time = 30/30, sound = "CW_KK_INS2_MINI14_BOLTBACK"},
		{time = 43/30, sound = "CW_KK_INS2_MINI14_BOLTRELEASE"},
	},
