...
SWEP.Sounds = {
	...
	base_ready = {
		{time = 0, sound = "CW_KK_INS2_UNIVERSAL_DRAW"},
		{time = 26/30, sound = "CW_KK_INS2_SPAS_PUMPBACK"},
		{time = 36/30, sound = "CW_KK_INS2_SPAS_PUMPFORWARD"},
	},
	...
	base_fire_cock_1 = {
		{time = 1/24, sound = "CW_KK_INS2_SPAS_PUMPBACK"},
		{time = 2/24, sound = "", callback = shell},
		{time = 5/24, sound = "CW_KK_INS2_SPAS_PUMPFORWARD"},
		// pumpedrdy @ 6 ""},
	},
	...
	base_reload_start_empty = {
		...
		{time = 18/35, sound = "CW_KK_INS2_SPAS_PUMPBACK"},
		{time = 20/35, sound = "", callback = shell},
		{time = 51/35, sound = "CW_KK_INS2_SPAS_SHELLINSERTSINGLE"},
		{time = 76/35, sound = "CW_KK_INS2_SPAS_PUMPFORWARD"},
		// reloaded @ 78 ""},
	},

	base_reload_insert = {
		{time = 5/36, sound = "CW_KK_INS2_SPAS_SHELLINSERT"},
		// reloaded @ 15 ""},
	},
	...
	iron_fire_cock_1 = {
		{time = 3/35, sound = "CW_KK_INS2_SPAS_PUMPBACK"},
		{time = 4/35, sound = "", callback = shell},
		{time = 11/35, sound = "CW_KK_INS2_SPAS_PUMPFORWARD"},
		// pumpedrdy @ 12 ""},
	},
	...
	foregrip_iron_fire_cock_1 = {
		{time = 3/35, sound = "CW_KK_INS2_SPAS_PUMPBACK", callback = shell},
		{time = 11/35, sound = "CW_KK_INS2_SPAS_PUMPFORWARD"},
		// pumpedrdy @ 12 ""},
	},
