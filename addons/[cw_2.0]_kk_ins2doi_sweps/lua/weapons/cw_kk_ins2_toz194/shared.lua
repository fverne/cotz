...
if CLIENT then
	...
	SWEP.AttachmentModelsVM = {
		{model = "models/weapons/upgrades/a_modkit_02.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, active = true},
	...
	SWEP.KKINS2KobraPos = Vector(-1.9996, -2, -0.2435)
	SWEP.KKINS2KobraAng = Vector()

	SWEP.KKINS2EoTechPos = Vector(-2.0115, -2, -0.1841)
	SWEP.KKINS2EoTechAng = Vector()

	SWEP.KKINS2AimpointPos = Vector(-2.008, -2, -0.17)
	SWEP.KKINS2AimpointAng = Vector()

	SWEP.KKINS2MagnifierPos = Vector(-2.0037, -1, -0.1927)
...
SWEP.ViewModel		= "models/weapons/ethereal/v_toz.mdl"
SWEP.WorldModel		= "models/weapons/ethereal/w_toz.mdl"

SWEP.WMPos = Vector(4.914, 0.759, -3.071)
