...
if CLIENT then
	...
	SWEP.AttachmentModelsWM = {
		...
		["kk_ins2_suppressor_ins"] = {model = "models/weapons/upgrades/w_sil_ins1.mdl", pos = Vector(-35.7,11.9,0), angle = Angle(0,0,90), size = Vector(1, 1, 1), attachment = "silencer"},

		["kk_ins2_lam"] = {model = "models/weapons/upgrades/w_laser_ins.mdl", pos = Vector(-0.2,0.2,8.8), angle = Angle(0,180,180), size = Vector(1, 1, 1), attachment = "laser"},
		["kk_ins2_flashlight"] = {model = "models/weapons/upgrades/w_laser_ins.mdl", pos = Vector(-0.2,0.2,8.8), angle = Angle(0,180,180), size = Vector(1, 1, 1), attachment = "laser"},
	...
	SWEP.IronsightPos = Vector(-2.165, -2, 0.78)
	SWEP.IronsightAng = Vector()

	SWEP.KKINS2EoTechPos = Vector(-2.165, -2, 0)
	SWEP.KKINS2EoTechAng = Vector()

	SWEP.KKINS2AimpointPos = Vector(-2.165, -2, 0)
	SWEP.KKINS2AimpointAng = Vector()

	SWEP.KKINS2KobraPos = Vector(-2.165, -2, 0)
	SWEP.KKINS2KobraAng = Vector()

	SWEP.KKINS2PO4Pos = Vector(-2.115, -1, 0.1)
	SWEP.KKINS2PO4Ang = Vector()

	SWEP.KKINS2MagnifierPos = Vector(-2.165, -1, 0.03)
	SWEP.KKINS2MagnifierAng = Vector()

	SWEP.KKINS2ElcanPos = Vector(-2.165, -1, -0.3)
	SWEP.KKINS2ElcanAng = Vector()
		
	SWEP.KKINS2CSTMCMorePos = Vector(-2.165, -2, 0)
	SWEP.KKINS2CSTMCMoreAng = Vector()

	SWEP.KKINS2CSTMBarskaPos = Vector(-2.165, -2, 0)
	SWEP.KKINS2CSTMBarskaAng = Vector()

	SWEP.KKINS2CSTMMicroT1Pos = Vector(-2.165, -2, 0)
	SWEP.KKINS2CSTMMicroT1Ang = Vector()

	SWEP.KKINS2CSTMEoTechXPSPos = Vector(-2.165, -2, 0)
	SWEP.KKINS2CSTMEoTechXPSAng = Vector()

	SWEP.KKINS2CSTMCompM4SPos = Vector(-2.165, -2, 0)
	SWEP.KKINS2CSTMCompM4SAng = Vector()

	SWEP.KKINS2CSTMACOGPos = Vector(-2.165, -1, -0.25)
...
SWEP.ViewModel		= "models/weapons/ethereal/v_uzi.mdl"
SWEP.WorldModel		= "models/weapons/ethereal/w_uzi.mdl"

SWEP.WMPos = Vector(5.176, 1.189, -1.417)
...
SWEP.FireSound = "CW_KK_INS2_UZI_FIRE"
SWEP.FireSoundSuppressed = "CW_KK_INS2_UZI_FIRE_SUPPRESSED"
SWEP.Recoil = 0.77
