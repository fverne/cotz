...
if CLIENT then
	...
	SWEP.IronsightPos = Vector(4.36, 0, 3.079)
	SWEP.IronsightAng = Vector(-0.101, -0.45, 0)
	...
	SWEP.AttachmentModelsVM = {
		["md_tundra9mm"] = {model = "models/cw2/attachments/9mmsuppressor.mdl", bone = "sten", pos = Vector(-15, -0.3, -0.65), angle = Angle(0, 90, 0), size = Vector(0.8, 0.8, 0.8)},
	}
...
SWEP.Sounds = {
	...
	reload = {
	[1] = {time = 0.1, sound = "CW_STEN_BOLTBACK"},
	[2] = {time = 1, sound = "CW_STEN_MAGOUT"},
	[3] = {time = 2, sound = "CW_STEN_MAGIN"},
	[4] = {time = 2.6, sound = "CW_STEN_BOLTFORWARD"}}
...
SWEP.ViewModel		= "models/weapons/v_smg_ste.mdl"
SWEP.WorldModel		= "models/weapons/w_smg_ste.mdl"
