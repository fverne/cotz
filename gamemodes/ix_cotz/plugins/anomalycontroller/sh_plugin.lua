...
if SERVER then
	...
	function PLUGIN:spawnArtifacts(point)
		...
		ix.item.Spawn(idat, point[1] + Vector( math.Rand(-8,8), math.Rand(-8,8), 20 ), function(item, ent) item:SetDat("bTemporary", true) ent.bTemporary = true ent.bArtifact = true end, AngleRand(), {})
