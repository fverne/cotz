...
function PANEL:Init()
	...
	proceed:Dock(BOTTOM)
	proceed:DockMargin(modelList:GetWide() * 0.8, 0, 0, 0)
	...
	descriptionBack:DockMargin(0, 0, descriptionModelList:GetWide() * 0.8, 0)
	...
	descriptionProceed:DockMargin(self.descriptionPanel:GetWide() * 0.8, 0, 0, 0)
	...
	attributesBack:DockMargin(0, 0, attributesModelList:GetWide() * 0.8, 0)
	...
	create:Dock(BOTTOM)
	create:DockMargin(self.attributesPanel:GetWide() * 0.8, 0, 0, 0)
