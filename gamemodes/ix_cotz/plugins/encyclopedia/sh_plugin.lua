...
function PLUGIN:PopulateHelpMenu(tabs)
    ...
    tabs["keybinds"] = function(container)
        ...
        note:SetText("Listed below are certain gamemode related keybinds, you can not change them as of yet.")
        note:Dock(TOP)
        ...
        local function = container:Add("DLabel")
        function:SetWrap(true)
        function:SetFont("stalkerregularfont")
        function:SetText("F1  -  Quick Help Menu")
        function:Dock(TOP)
        function:DockMargin(0, 16, 0, 0)
        function:SetAutoStretchVertical(true)
