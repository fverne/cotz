...
ITEM.functions.use = {
	...
	OnCanRun = function(item)
		return (!IsValid(item.entity)) and (item:GetData("stashcoordinates", nil) == nil) and (item:GetData("moneytaken", nil) != true) and item.invID == client:GetCharacter():GetInventory():GetID()
	end
}
