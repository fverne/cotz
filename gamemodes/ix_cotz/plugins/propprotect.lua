...
PLUGIN.author = "Chessnut - Small changes by gumlefar"
PLUGIN.description = "Adds a simple prop protection system. Overridden to fix problems with automatic AdvDupe2 spawning"
