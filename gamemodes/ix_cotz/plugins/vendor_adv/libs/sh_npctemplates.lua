...
ix.npctemplates.templates["tutorialnpc"] = {
	...
	-- ["uniqueid"] = { 1: Special set price, 2: Starting stock, 3: Mode [1:B/S, 2:S, 3:B], 4: Maximum stock, 5: Restock interval in hours, 6: Restock amount }
		...
		["mask_halfmask"] 	= { 15000, 10, SELLONLY, 10, 1, 10 }, -- expensive on purpose
		["mask_gp5"] 	= { 40000, 10, SELLONLY, 10, 1, 10 }, -- expensive on purpose
		...
		["part_electrocontroller_1"] 	= { 1, nil, BUYONLY, nil, nil, nil },
		["part_electrocontroller_2"] 	= { 1, nil, BUYONLY, nil, nil, nil },
		["part_flesh"] 	= { 1, nil, BUYONLY, nil, nil, nil },
		["part_izlom"] 	= { 1, nil, BUYONLY, nil, nil, nil },
		["part_hellhound"] 	= { 1, nil, BUYONLY, nil, nil, nil },
		["part_karlik"] 	= { 1, nil, BUYONLY, nil, nil, nil },
		["part_pseudodog"] 	= { 1, nil, BUYONLY, nil, nil, nil },
		["part_pseudogiant"] 	= { 1, nil, BUYONLY, nil, nil, nil },
		...
		["part_spider"] 	= { 1, nil, BUYONLY, nil, nil, nil },
		...
		["part_tark"] 	= { 1, nil, BUYONLY, nil, nil, nil },
		["part_tushkano"] 	= { 1, nil, BUYONLY, nil, nil, nil },
		["part_vareshka"] 	= { 1, nil, BUYONLY, nil, nil, nil },
		...
		["hide_bear"] 	= { 1, nil, BUYONLY, nil, nil, nil },
...
ix.npctemplates.templates["ecologistnpc"] = {
	...
	-- ["uniqueid"] = { 1: Special set price, 2: Starting stock, 3: Mode [1:B/S, 2:S, 3:B], 4: Maximum stock, 5: Restock interval in hours, 6: Restock amount }
		...
		["part_izlom"] 	= { 1, nil, BUYONLY, nil, nil, nil },
		["part_hellhound"] 	= { 1, nil, BUYONLY, nil, nil, nil },
		["part_karlik_1"] 	= { 1, nil, BUYONLY, nil, nil, nil },
		["part_karlik_2"] 	= { 1, nil, BUYONLY, nil, nil, nil },
		["part_pseudodog"] 	= { 1, nil, BUYONLY, nil, nil, nil },
		["part_pseudogiant"] 	= { 1, nil, BUYONLY, nil, nil, nil },
		["part_psydog"] 	= { 1, nil, BUYONLY, nil, nil, nil },
		["part_skeleton"] 	= { 1, nil, BUYONLY, nil, nil, nil },
		...
		["artifact_arachno"] = { 1, nil, BUYONLY, nil, nil, nil },
		...
		["artifact_droplet"] = { 1, nil, BUYONLY, nil, nil, nil },
		["artifact_dwarfgalaxy"] = { 1, nil, BUYONLY, nil, nil, nil },
		["artifact_eye"] = { 1, nil, BUYONLY, nil, nil, nil },
		["artifact_flame"] = { 1, nil, BUYONLY, nil, nil, nil },
		["artifact_flash"] = { 1, nil, BUYONLY, nil, nil, nil },
		["artifact_gaia"] = { 1, nil, BUYONLY, nil, nil, nil },
		["artifact_galaxy"] = { 1, nil, BUYONLY, nil, nil, nil },
		["artifact_gmamasbeads"] = { 1, nil, BUYONLY, nil, nil, nil },
		["artifact_halo"] = { 1, nil, BUYONLY, nil, nil, nil },
		["artifact_kolobok"] = { 1, nil, BUYONLY, nil, nil, nil },
		["artifact_mamasbeads"] = { 1, nil, BUYONLY, nil, nil, nil },
		["artifact_mementomori"] = { 1, nil, BUYONLY, nil, nil, nil },
		["artifact_mica"] = { 1, nil, BUYONLY, nil, nil, nil },
		["artifact_midas"] = { 1, nil, BUYONLY, nil, nil, nil },
		["artifact_moonlight"] = { 1, nil, BUYONLY, nil, nil, nil },
		["artifact_mycelia"] = { 1, nil, BUYONLY, nil, nil, nil },
		["artifact_panacea"] = { 1, nil, BUYONLY, nil, nil, nil },
		["artifact_slime"] = { 1, nil, BUYONLY, nil, nil, nil },
		["artifact_slug"] = { 1, nil, BUYONLY, nil, nil, nil },
