...
function PANEL:Init()
	...
	back:Dock(BOTTOM)
	back:SetText("return")
	back:DockMargin(0, 0, controlList:GetWide()*0.7, 0)
	back:SizeToContents()
	...
	self.characterList:DockMargin(0, 0, controlList:GetWide()*0.7, 0)
	...
	infoButtons:DockPadding(ScrW()*0.22, 0, ScrW()*0.215, 0)
	...
	deleteReturn:DockMargin(0, 0, ScrW()*0.4, 0)
