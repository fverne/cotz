...
function PANEL:Init()
	...
	self.buttons:SetSize(self:GetWide() * 0.15, self:GetTall() - self:GetPadding() * 2)
	...
	self.modelpanelframe:SetSize(ScrW() * 0.15, ScrH()* 0.28)
	...
	characters:SetPos(self:GetWide() * 0.98, /*self:GetTall() - characters:GetTall() * 1.2*/ 0)
	characters:SetSize(ScrW() * 0.0166, ScrH() * 0.0296)
