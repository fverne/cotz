ITEM.name = "14.5x114mm Armor-Piercing"
ITEM.model = "models/lostsignalproject/items/ammo/127x55.mdl"
ITEM.ammo = "14.5x114MM -AP-" // type of the ammo
ITEM.ammoAmount = 60 // amount of the ammo
ITEM.description= "A box that contains %s rounds of Armor-Piercing 14.5x114mm ammo. "
...
ITEM.width = 2
ITEM.height = 1
ITEM.img = ix.util.GetMaterial("cotz/icons/ammo/ammo_long_41_1.png")
