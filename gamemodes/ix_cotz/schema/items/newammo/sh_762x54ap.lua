...
ITEM.description = ""
ITEM.quantdesc =  "A box that contains %s rounds of Armor-Piercing 7.62x54mm ammo. "
...
ITEM.width = 2
ITEM.height = 1
ITEM.img = ix.util.GetMaterial("cotz/icons/ammo/ammo_long_12_1.png")
