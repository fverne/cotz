...
LANGUAGE = {
	...
	chooseDescription = "Select Your Appearance",
	chooseSkills = "Select Your Background",
	name = "You Are",
	...
	youreDead = "In the Hands of the Zone",
	...
	vendorBuyCooldown = "You are buying too fast from this vendor!",
	vendorItemDropped = "Your purchased item dropped on the ground!",
	...
	optHotkey1 = "Set an item for F1",
	optHotkey2 = "Set an item for F2",
	optHotkey3 = "Set an item for F3",
	optHotkey4 = "Set an item for F4",
	...
	optDisablehud = "Disable Hud",
	optdDisablehud = "Disables the UI elements on your screen such as your health bar. Good for if you want to feel more immersed.",
	optDisableCrosshair = "Disable Crosshair",
	optdDisableCrosshair = "Disables the crosshair that appears on your screen.",
	optPermvoicehud = "Permanent Voice Mode HUD Display",
	optdPermvoicehud = "Enables the voice mode HUD display even if you are not talking. (Enabling Disable HUD will disable this no matter what, even when talking.)",
	optVoicemodehudtip = "Voice Mode HUD Tip",
	optdVoicemodehudtip = "Enables the little voice mode changing tip underneath the voice mode icon when you are talking.",
