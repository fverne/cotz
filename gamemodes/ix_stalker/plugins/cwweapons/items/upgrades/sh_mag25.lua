ITEM.name = "Magazine +25"
ITEM.description = "Adds twenty five rounds to the magazine capacity."
ITEM.category = "Upgrades"
ITEM.model = "models/ethprops/crafting/toolkit_nato.mdl"
ITEM.width = 2
ITEM.height = 1
ITEM.price = 1755
ITEM.slot = 2
