...
ix.npctemplates.templates["cooknpc"] = {
	...
	-- ["uniqueid"] = { 1: Special set price, 2: Starting stock, 3: Mode [1:B/S, 2:S, 3:B], 4: Maximum stock, 5: Restock interval in hours, 6: Restock amount }
		...
		["drug_cigarette_1"] 	= { nil, 2, SELLANDBUY, 10, 0.10, 2 },
		["drug_cigarette_2"] 	= { nil, 2, SELLANDBUY, 10, 0.10, 2 },
		["drug_cigarette_3"] 	= { nil, 2, SELLANDBUY, 10, 0.10, 2 },

		["drink_bottlebeer_1"] 	= { nil, 2, SELLANDBUY, 6, 0.10, 2 },
		["drink_bottletea"] 	= { nil, 2, SELLANDBUY, 6, 0.10, 2 },
		["drink_bottlewater"] 	= { nil, 2, SELLANDBUY, 6, 0.10, 2 },
		["drink_vodka_1"] 	= { nil, 2, SELLANDBUY, 6, 0.10, 2 },
		["drink_vodka_2"] 	= { nil, 2, SELLANDBUY, 6, 0.10, 2 },
		["drink_vodka_3"] 	= { nil, 2, SELLANDBUY, 6, 0.10, 2 },
        ["food_bread"] 	= { nil, 2, SELLANDBUY, 6, 0.10, 2 },
        ["food_nuts_1"] 	= { nil, 2, SELLANDBUY, 6, 0.10, 2 },
        ["food_oldmeat"] 	= { nil, 2, SELLANDBUY, 6, 0.10, 2 },
        ["food_sausage_1"] 	= { nil, 2, SELLANDBUY, 6, 0.10, 2 },
        ["food_can_sprats"] 	= { nil, 2, SELLANDBUY, 6, 0.10, 2 },
