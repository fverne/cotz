ITEM.name = "7.62x51mm Hollow-Point"
ITEM.model = "models/lostsignalproject/items/ammo/762x51.mdl"
ITEM.width = 2
ITEM.height = 1
ITEM.ammo = "7.62x51MM -HP-" // type of the ammo
ITEM.ammoAmount = 60 // amount of the ammo
ITEM.description= "A box that contains %s rounds of Hollow-Point 7.62x51mm ammo. "
...
ITEM.price = 1950
ITEM.img = ix.util.GetMaterial("cotz/icons/ammo/ammo_long_28_2.png")
