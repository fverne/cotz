local att = {}
att.name = "kk_ins2_scope_nam_colt"
att.displayNameShort = "Colt"
att.displayName = "Colt"
att.aimPos = {"KKINS2NAMColtPos", "KKINS2NAMColtAng"}
att.FOVModifier = 0
...
if CLIENT then
	...
	local path = "models/weapons/nam/m16a1/colt_scope_reticule"
