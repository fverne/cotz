...
CustomizableWeaponry:registerAmmo(".700 Nitro Express", ".700 Nitro Express", 17.8, 89)
...
CustomizableWeaponry:registerAmmo("12 Gauge -MG-", "12 Gauge Magnum Buckshot", 5, 10,DMG_AIRBOAT)
...
--HOLLOWPOINT AMMO
CustomizableWeaponry:registerAmmo("7.62x25MM -HP-", "7.62x25MM Rounds - Overpressure", 7.62, 25)
CustomizableWeaponry:registerAmmo("7.62x39MM -HP-", "7.62x39MM Rounds - Overpressure", 7.62, 39)
CustomizableWeaponry:registerAmmo("7.62x51MM -HP-", "7.62x51MM Rounds - Overpressure", 7.62, 51)
CustomizableWeaponry:registerAmmo("7.62x54MMR -HP-", "7.62x54MMR Rounds - Overpressure", 7.62, 39)
CustomizableWeaponry:registerAmmo("7.62x54MM -HP-", "7.62x54MM Rounds - Overpressure", 7.62, 54)
CustomizableWeaponry:registerAmmo("5.45x39MM -HP-", "5.45x39MM Rounds - Overpressure", 5.45, 39)
CustomizableWeaponry:registerAmmo("5.56x45MM -HP-", "5.56x45MM Rounds - Overpressure", 5.56, 45)
CustomizableWeaponry:registerAmmo("5.7x28MM -HP-", "5.7x28MM Rounds - Overpressure", 5.7, 28)
CustomizableWeaponry:registerAmmo("14.5x114MM -HP-", "14.5x114MM Rounds - Overpressure", 14.5, 114)
CustomizableWeaponry:registerAmmo(".22LR -HP-", ".22LR Rounds - Overpressure", 5.7, 15.6)
CustomizableWeaponry:registerAmmo(".338 Lapua -HP-", ".338 Lapua Rounds - Overpressure", 8.58, 69.20)
CustomizableWeaponry:registerAmmo(".357 Magnum -HP-", ".357 Magnum Rounds - Overpressure", 9, 33.6)
CustomizableWeaponry:registerAmmo(".44 Magnum -HP-", ".44 Magnum Rounds - Overpressure", 10.9, 32.6)
CustomizableWeaponry:registerAmmo(".500 Magnum -HP-", ".500 Magnum Rounds - Overpressure", 12.7, 41.6)
CustomizableWeaponry:registerAmmo(".45 ACP -HP-", ".45 ACP Rounds - Overpressure", 11.5, 22.8)
CustomizableWeaponry:registerAmmo(".50 AE -HP-", ".50 AE Rounds - Overpressure", 12.7, 32.6)
CustomizableWeaponry:registerAmmo("9x18MM -HP-", "9x18MM Rounds - Overpressure", 9, 18)
CustomizableWeaponry:registerAmmo("9x19MM -HP-", "9x19MM Rounds - Overpressure", 9, 19)
CustomizableWeaponry:registerAmmo("9x21MM -HP-", "9x21MM Gyurza - Overpressure", 9, 21)
CustomizableWeaponry:registerAmmo("9x39MM -HP-", "9x39MM Rounds - Overpressure", 9, 39)