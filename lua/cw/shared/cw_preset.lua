...
CustomizableWeaponry.preset.enabled = false -- set this to 'false' to disable preset saving/loading
...
function CustomizableWeaponry.preset:save(name)
	...
	if not table.IsEmpty(colors) then
...
if CLIENT then
	function CustomizableWeaponry.preset:makeSavePopup()
		...
		function textBox.OnMousePressed(panel)
			panel:SetText("")
		end

		function textBox.OnTextChanged(panel)
