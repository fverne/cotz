...
function ENT:Initialize()
	self.Model = "models/stalker/new_izlom_spen.mdl"
	...
	TEMP_MeleeTable.time[1] = 0.6
	TEMP_MeleeTable.bone[1] = "bip01_head"
	self:STALKERNPCSetMeleeParams(6,"stand_run_attack_0",1, TEMP_MeleeTable,TEMP_MeleeHitTable,TEMP_MeleeMissTable)
...
function ENT:STALKERNPCThink()
	...
	if (self.jumping1 < CurTime()) and self.isAttacking == 1 then
		...
		self:STALKERNPCPlayAnimation("stand_run_attack_0",6)
