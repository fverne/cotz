...
if CLIENT then
	...
	SWEP.PSOPos = Vector(-2.5, 4.65, -0.101)
	...
	SWEP.AttachmentModelsVM = {
		...
		["md_pbs1"] = {model = "models/cw2/attachments/pbs1.mdl", bone = "ak74_body", pos = Vector(-14, 0, -0.88), angle = Angle(0, 90, 0), size = Vector(1, 1, 1)},
