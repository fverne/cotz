...
if (SERVER) then
	util.AddNetworkString("CW20_ANIMATE")
	util.AddNetworkString("CW20_EFFECTS")
end
...
if CLIENT then
	local function CW20_ANIMATE(length)
	...
	net.Receive("CW20_ANIMATE", CW20_ANIMATE)
	...
	net.Receive("CW20_EFFECTS", CW20_EFFECTS)
end