...
if CLIENT then
	...
	SWEP.AimpointPos = Vector(-2.6, -2.59, -0.1)
	SWEP.AimpointAng = Vector(0, 0, 0)
	
	SWEP.CmorePos = Vector(-2.6, 1.5, 0.17)
	SWEP.CmoreAng = Vector(0, 0, 0)
	
	SWEP.ReflexPos = Vector(-2.6, -3.823, 0.3)
	...
	SWEP.ACOGPos = Vector(-2.603, -2.875, -0.09)
	...
	SWEP.AttachmentModelsVM = {
		...
		["md_aimpoint"] = {model = "models/wystan/attachments/aimpoint.mdl", bone = "body", pos = Vector(-3, 1.1, 0.25), angle = Angle(270, 90, 0), size = Vector(1, 1, 1)},
		...
		["md_reflex"] = { type = "Model", model = "models/attachments/kascope.mdl", bone = "body", rel = "", pos = Vector(4, -4.7, 0), angle = Angle(270, 90, 0), size = Vector(0.55, 0.55, 0.55), color = Color(255, 255, 255, 0)},
		["md_cmore"] = { type = "Model", model = "models/attachments/cmore.mdl", bone = "body", rel = "", pos = Vector(3, -4.4, 0), angle = Angle(270, 0, 270), size = Vector(0.649, 0.649, 0.649), color = Color(255, 255, 255, 0)},
		["md_acog"] = {model = "models/wystan/attachments/2cog.mdl", bone = "body", pos = Vector(-2, -0.3, 0.28), angle = Angle(-90, 0, -90), size = Vector(0.75, 0.75, 0.75)},
	}
