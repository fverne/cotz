CustomizableWeaponry:addFireSound("CW_KK_INS2_AK12_FIRE", "weapons/ak12/ak12_fp.wav")
CustomizableWeaponry:addFireSound("CW_KK_INS2_AK12_FIRE_SUPPRESSED", "weapons/ak12/ak12_suppressed_fp.wav")
