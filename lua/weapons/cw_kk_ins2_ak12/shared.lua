...
if CLIENT then
	...
	SWEP.AttachmentModelsVM = {
		["handguardStandard"] = {model = "models/weapons/ethereal/upgrades/a_standard_ak12.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, active = true},
		
		["kk_ins2_pbs5"] = {model = "models/weapons/upgrades/a_suppressor_aks.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},

		["kk_ins2_vertgrip"] = {model = "models/weapons/ethereal/upgrades/a_foregrip_ak12.mdl", pos = Vector(), angle = Angle(), size = Vector(1,1,1), merge = true},
	...
	SWEP.AttachmentModelsWM = {
		["kk_ins2_pbs5"] = {model = "models/weapons/upgrades/w_sil_ins1.mdl", pos = Vector(-36.7,12,0), angle = Angle(0,0,90), size = Vector(1, 1, 1), attachment = "silencer"},

		["kk_ins2_vertgrip"] = {model = "models/weapons/upgrades/w_foregrip_sec1.mdl", pos = Vector(10,2.8,0), angle = Angle(0,0,-90), size = Vector(1,1,1), attachment = "optic"},
	...
	SWEP.IronsightPos = Vector(-2.1169, -2, 0.5804)
	SWEP.IronsightAng = Vector(0.35, 0, 0)

	SWEP.KKINS2KobraPos = Vector(-2.1169, -1, -0.5297)
	SWEP.KKINS2KobraAng = Vector()

	SWEP.KKINS2EoTechPos = Vector(-2.1169, -1, -0.4297)
	SWEP.KKINS2EoTechAng = Vector()

	SWEP.KKINS2AimpointPos = Vector(-2.1169, -1, -0.4297)
	SWEP.KKINS2AimpointAng = Vector()

	SWEP.KKINS2ElcanPos = Vector(-2.1169, -3, -0.6197)
	SWEP.KKINS2ElcanAng = Vector()

	SWEP.KKINS2PO4Pos = Vector(-2.0556, -2.5, -0.3797)
	SWEP.KKINS2PO4Ang = Vector()

	SWEP.KKINS2MagnifierPos = Vector(-2.1069, -1, -0.4297)
	SWEP.KKINS2MagnifierAng = Vector()

	SWEP.KKINS2CSTMCMorePos = Vector(-2.1169, -1, -0.4297)
	SWEP.KKINS2CSTMCMoreAng = Vector()

	SWEP.KKINS2CSTMBarskaPos = Vector(-2.1169, -1, -0.4297)
	SWEP.KKINS2CSTMBarskaAng = Vector()

	SWEP.KKINS2CSTMMicroT1Pos = Vector(-2.1169, -1, -0.4297)
	SWEP.KKINS2CSTMMicroT1Ang = Vector()
	
	SWEP.KKINS2CSTMEoTechXPSPos = Vector(-2.1169, -1, -0.4297)
	SWEP.KKINS2CSTMEoTechXPSAng = Vector()

	SWEP.KKINS2CSTMCompM4SPos = Vector(-2.1169, -1, -0.4297)
	SWEP.KKINS2CSTMCompM4SAng = Vector()

	SWEP.KKINS2CSTMACOGPos = Vector(-2.1169, -2, -0.5597)
...
SWEP.ViewModel		= "models/weapons/ethereal/v_ak12.mdl"
SWEP.WorldModel		= "models/weapons/ethereal/w_ak12.mdl"

SWEP.WMPos = Vector(4.666, 1.16, -1.055)
...
SWEP.FireSound = "CW_KK_INS2_AK12_FIRE"
SWEP.FireSoundSuppressed = "CW_KK_INS2_AK12_FIRE_SUPPRESSED"
SWEP.Recoil = 1.0
