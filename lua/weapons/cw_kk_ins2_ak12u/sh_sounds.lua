CustomizableWeaponry:addFireSound("CW_KK_INS2_AK12U_FIRE", "weapons/ak12u/ak12u_fp.wav")
CustomizableWeaponry:addFireSound("CW_KK_INS2_AK12U_FIRE_SUPPRESSED", "weapons/ak12u/ak12u_suppressed_fp.wav")
