...
CustomizableWeaponry:registerAmmo("7.62x39MM AP", "7.62x39MM AP", 762, 38)
CustomizableWeaponry:registerAmmo("7.62x39MM MG", "7.62x39MM MG", 762, 37)
...
if CLIENT then
	...
	SWEP.AttachmentModelsVM = {
		...
		["handguardStandard"] = {model = "models/weapons/upgrades/a_standard_akm.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, active = true},

		["kk_ins2_pbs1"] = {model = "models/weapons/upgrades/a_suppressor_ak.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},

		["kk_ins2_vertgrip"] = {model = "models/weapons/upgrades/a_woodgrips_akm.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},
	...
	SWEP.AttachmentModelsWM = {
		...
		["handguardStandard"] = {model = "models/weapons/upgrades/w_standard_akm.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, active = true},

		["kk_ins2_pbs1"] = {model = "models/weapons/upgrades/w_sil_ins1.mdl", pos = Vector(-33.1,0,11.9), angle = Angle(), size = Vector(1, 1, 1), attachment = "silencer"},

		["kk_ins2_vertgrip"] = {model = "models/weapons/upgrades/w_foregrip_wood_1.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},
		...
		["kk_ins2_lam"] = {model = "models/weapons/upgrades/w_laser_ins.mdl", pos = Vector(0,0,8.26), angle = Angle(0,180,180), size = Vector(1, 1, 1), attachment = "laser"},
		["kk_ins2_flashlight"] = {model = "models/weapons/upgrades/w_laser_ins.mdl", pos = Vector(0,0,8.26), angle = Angle(0,180,180), size = Vector(1, 1, 1), attachment = "laser"},
...
SWEP.ViewModel		= "models/weapons/ethereal/v_akm.mdl"
SWEP.WorldModel		= "models/weapons/ethereal/w_akm.mdl"

SWEP.WMPos = Vector(4.666, 0.96, -1.055)
