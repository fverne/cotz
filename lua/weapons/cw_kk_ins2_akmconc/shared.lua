...
if CLIENT then
	...
	SWEP.AttachmentModelsVM = {
		...
		["handguardStandard"] = {model = "models/weapons/ethereal/akmconc_upgrades/a_standard_akm.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), attachment = "muzzle", active = true},

		["kk_ins2_pbs1"] = {model = "models/weapons/upgrades/a_suppressor_ak.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},

		["kk_ins2_vertgrip"] = {model = "models/weapons/ethereal/akmconc_upgrades/a_woodgrips_akm.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},
		...
		["anims"] = {model = "models/weapons/ethereal/v_akmconc_anims.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, active = true},
	}
	...
	SWEP.AttachmentModelsWM = {
		...
		["kk_ins2_pbs1"] = {model = "models/weapons/upgrades/w_sil_ins1.mdl", pos = Vector(-33.75,0,11.9), angle = Angle(), size = Vector(1, 1, 1), attachment = "silencer"},

		["kk_ins2_vertgrip"] = {model = "models/weapons/upgrades/w_foregrip_sec2.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},
		
		["kk_ins2_lam"] = {model = "models/weapons/upgrades/w_laser_ins.mdl", pos = Vector(0,-0.15,8.3), angle = Angle(0,180,180), size = Vector(1, 1, 1), attachment = "laser"},
		["kk_ins2_flashlight"] = {model = "models/weapons/upgrades/w_laser_ins.mdl", pos = Vector(0,-0.15,8.3), angle = Angle(0,180,180), size = Vector(1, 1, 1), attachment = "laser"},
...
SWEP.ViewModel		= "models/weapons/ethereal/v_akmconc.mdl"
SWEP.WorldModel		= "models/weapons/ethereal/w_akmconc.mdl"

SWEP.WMPos = Vector(4.666, 1.1, -1.255)
