...
SWEP.Sounds = {
	base_ready = {
		...
		{time = 9/30, sound = "CW_KK_INS2_P99_BOLTBACK"},
		{time = 19/30, sound = "CW_KK_INS2_P99_BOLTRELEASE"},
	},
	...
	base_reload = {
		...
		{time = 19/30, sound = "CW_KK_INS2_P99_MAGOUT"},
		{time = 35/30, sound = "CW_KK_INS2_P99_MAGIN"},
	},

	base_reloadempty = {
		{time = 0/30, sound = "CW_KK_INS2_M9_MAGRELEASE"},
		{time = 7/30, sound = "CW_KK_INS2_P99_MAGOUT"},
		{time = 35/30, sound = "CW_KK_INS2_P99_MAGIN"},
		{time = 71/30, sound = "CW_KK_INS2_P99_BOLTRELEASE"},
	},
