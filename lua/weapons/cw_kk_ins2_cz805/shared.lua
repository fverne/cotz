...
if CLIENT then
	...
	SWEP.AttachmentModelsVM = {
		["kk_ins2_optic_iron"] = {model = "models/weapons/ethereal/upgrades/a_carryhandle_sca.mdl", pos = Vector(-1.865,1.29,-10), angle = Angle(89,90,0), size = Vector(.8, .8, .8), bone = "A_Optic", active = true},
	...
	SWEP.AttachmentModelsWM = {
		["kk_ins2_optic_iron"] = {model = "models/weapons/ethereal/upgrades/w_flipup2.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, active = true},

		["kk_ins2_suppressor_sec"] = {model = "models/weapons/upgrades/w_sil_sec2.mdl", pos = Vector(-35.4,-4.1,0), angle = Angle(0,0,-90), size = Vector(1, 1, 1), attachment = "silencer"},
		...
		["kk_ins2_lam"] = {model = "models/weapons/upgrades/w_laser_sec.mdl", pos = Vector(0,-8.3,-0.1), angle = Angle(180,0,90), size = Vector(1, 1, 1), attachment = "laser"},
		["kk_ins2_flashlight"] = {model = "models/weapons/upgrades/w_laser_sec.mdl", pos = Vector(0,-8.3,-0.1), angle = Angle(180,0,90), size = Vector(1, 1, 1), attachment = "laser"},
	...
	SWEP.IronsightPos = Vector(-2.549, -2, 0)
	SWEP.IronsightAng = Vector(0, 0, 0)

	SWEP.KKINS2KobraPos = Vector(-2.549, -2, -0.1)
	SWEP.KKINS2KobraAng = Vector()

	SWEP.KKINS2EoTechPos = Vector(-2.549, -2, -0.25)
	SWEP.KKINS2EoTechAng = Vector()

	SWEP.KKINS2AimpointPos = Vector(-2.549, -2, -0)
	SWEP.KKINS2AimpointAng = Vector()

	SWEP.KKINS2ElcanPos = Vector(-2.549, -3.7, -0.4)
	SWEP.KKINS2ElcanAng = Vector()

	SWEP.KKINS2PO4Pos = Vector(-2.479, -3.7, 0.05)
	SWEP.KKINS2PO4Ang = Vector()

	SWEP.KKINS2MagnifierPos = Vector(-2.549, -3.5, -0)
	SWEP.KKINS2MagnifierAng = Vector()
	
	SWEP.KKINS2CSTMCMorePos = Vector(-2.549, -2, -0)
	SWEP.KKINS2CSTMCMoreAng = Vector()

	SWEP.KKINS2CSTMBarskaPos = Vector(-2.549, -2, -0.25)
	SWEP.KKINS2CSTMBarskaAng = Vector()

	SWEP.KKINS2CSTMMicroT1Pos = Vector(-2.549, -2, -0)
	SWEP.KKINS2CSTMMicroT1Ang = Vector()
	
	SWEP.KKINS2CSTMEoTechXPSPos = Vector(-2.549, -2, -0)
	SWEP.KKINS2CSTMEoTechXPSAng = Vector()

	SWEP.KKINS2CSTMCompM4SPos = Vector(-2.549, -2, -0)
	SWEP.KKINS2CSTMCompM4SAng = Vector()
	
	SWEP.KKINS2CSTMACOGPos = Vector(-2.549, -4, -0.4)
...
SWEP.ViewModel		= "models/weapons/ethereal/v_cz805.mdl"
SWEP.WorldModel		= "models/weapons/ethereal/w_cz805.mdl"

SWEP.WMPos = Vector(5.018, 0.711, -1.143)
...
SWEP.FireSound = "CW_KK_INS2_CZ805_FIRE"
SWEP.FireSoundSuppressed = "CW_KK_INS2_CZ805_FIRE_SUPPRESSED"
SWEP.Recoil = 1.1025
