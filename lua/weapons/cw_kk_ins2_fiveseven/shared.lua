...
CustomizableWeaponry:registerAmmo("5.7x28MM AP", "5.7x28MM AP", 5.7, 27)
CustomizableWeaponry:registerAmmo("5.7x28MM MG", "5.7x28MM MG", 5.7, 29)
...
if CLIENT then
	...
	SWEP.AttachmentModelsWM = {
		["kk_ins2_suppressor_pistol"] = {model = "models/weapons/upgrades/w_sil_pistol.mdl", pos = Vector(-33.55,0.1,9.3), angle = Angle(), size = Vector(1, 1, 1), attachment = "Silencer"},
	...
	SWEP.IronsightPos = Vector(-1.559, 0, 0.18)
...
SWEP.ViewModel		= "models/weapons/ethereal/v_fiveseven.mdl"
SWEP.WorldModel		= "models/weapons/ethereal/w_fiveseven.mdl"
...
SWEP.FireDelay = 0.1
SWEP.FireSound = "CW_KK_INS2_FIVESEVEN_FIRE"
SWEP.FireSoundSuppressed = "CW_KK_INS2_FIVESEVEN_FIRE_SUPPRESSED"
SWEP.Recoil = 1
