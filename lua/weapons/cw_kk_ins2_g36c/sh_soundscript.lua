...
SWEP.Sounds = {
	base_ready = {
		...
		{time = 17/30, sound = "CW_KK_INS2_G36C_BOLTBACK"},
		{time = 26/30, sound = "CW_KK_INS2_G36C_BOLTRELEASE"},
	},
	...
	base_reload = {
		...
		{time = 37/30, sound = "CW_KK_INS2_G36C_MAGOUT"},
		{time = 61/30, sound = "CW_KK_INS2_G36C_MAGIN"},
	},
	...
	base_reloadempty = {
		...
		{time = 37/30, sound = "CW_KK_INS2_G36C_MAGOUT"},
		{time = 61/30, sound = "CW_KK_INS2_G36C_MAGIN"},
		{time = 100/30, sound = "CW_KK_INS2_G36C_BOLTRELEASE"},
	},
	...
	foregrip_reloadempty = {
		...
		{time = 37/30, sound = "CW_KK_INS2_G36C_MAGOUT"},
		{time = 61/30, sound = "CW_KK_INS2_G36C_MAGIN"},
		{time = 90/30, sound = "CW_KK_INS2_G36C_BOLTRELEASE"},
	},
	...
	gl_reload = {
		{time = 16/30, sound = "CW_KK_INS2_M4A1_MAGRELEASE"},
		{time = 17/30, sound = "CW_KK_INS2_G36C_MAGOUT"},
		{time = 71/30, sound = "CW_KK_INS2_G36C_MAGIN"},
	...
	gl_reloadempty = {
		...
		{time = 71/30, sound = "CW_KK_INS2_G36C_MAGIN"},
		{time = 87/30, sound = "CW_KK_INS2_M4A1_HIT"},
		{time = 112/30, sound = "CW_KK_INS2_G36C_BOLTRELEASE"},
	},
