...
if CLIENT then
	...
	SWEP.AttachmentModelsVM = {
		["kk_ins2_optic_iron"] = {model = "models/weapons/ethereal/upgrades/a_carryhandle_sca.mdl", pos = Vector(-1.64,1.22,-7), angle = Angle(88,90,0), size = Vector(.7, .7, .7), bone = "A_Optic", active = true},
	...
	SWEP.AttachmentModelsWM = {
		["bg_foldsight"] = {model = "models/weapons/attachments/w_cw_kk_ins2_flipsight.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, active = true},
		...
		["kk_ins2_lam"] = {model = "models/weapons/upgrades/w_laser_sec.mdl", pos = Vector(1,0,-8.3), angle = Angle(0,180,0), size = Vector(1, 1, 1), attachment = "laser"},
		["kk_ins2_flashlight"] = {model = "models/weapons/upgrades/w_laser_sec.mdl", pos = Vector(1,0,-8.3), angle = Angle(0,180,0), size = Vector(1, 1, 1), attachment = "laser"},

		["kk_ins2_magnifier"] = {model = "models/weapons/upgrades/w_magaim.mdl", pos = Vector(-24,10.9,0), angle = Angle(0,0,-90), size = Vector(1, 1, 1), attachment = "optic"},

		["kk_ins2_aimpoint"] = {model = "models/weapons/upgrades/w_aimpoint.mdl", pos = Vector(-35,10.9,0), angle = Angle(0,0,-90), size = Vector(1, 1, 1), attachment = "optic"},
		["kk_ins2_elcan"] = {model = "models/weapons/upgrades/w_elcan.mdl", pos = Vector(-43,10.8,0), angle = Angle(0,0,-90), size = Vector(1, 1, 1), attachment = "optic"},
		["kk_ins2_eotech"] = {model = "models/weapons/upgrades/w_eotech.mdl", pos = Vector(9,15.5,0), angle = Angle(0,0,-90), size = Vector(1, 1, 1), attachment = "optic"},
		["kk_ins2_kobra"] = {model = "models/weapons/upgrades/w_kobra.mdl", pos = Vector(-25,19.5,0), angle = Angle(0,0,-90), size = Vector(1, 1, 1), attachment = "optic"},
		["kk_ins2_po4"] = {model = "models/weapons/upgrades/w_po.mdl", pos = Vector(-51,11,0), angle = Angle(0,0,-90), size = Vector(1, 1, 1), attachment = "optic"},

		["kk_ins2_cstm_cmore"] = {model = "models/weapons/attachments/w_cw_kk_ins2_cstm_cmore.mdl", pos = Vector(-25,19), angle = Angle(0,0,-90), size = Vector(1, 1, 1), attachment = "optic"},
		["kk_ins2_cstm_compm4s"] = {model = "models/weapons/upgrades/w_aimpoint.mdl", pos = Vector(-35,10.9,0), angle = Angle(0,0,-90), size = Vector(1, 1, 1), attachment = "optic"},
		["kk_ins2_cstm_microt1"] = {model = "models/weapons/upgrades/w_aimpoint.mdl", pos = Vector(-35,10.9,0), angle = Angle(0,0,-90), size = Vector(1, 1, 1), attachment = "optic"},
		["kk_ins2_cstm_acog"] = {model = "models/weapons/attachments/w_cw_kk_ins2_cstm_acog.mdl", pos = Vector(-44,10.7,0), angle = Angle(0,0,-90), size = Vector(1, 1, 1), attachment = "optic"},
		["kk_ins2_cstm_barska"] = {model = "models/weapons/upgrades/w_eotech.mdl", pos = Vector(9,15.5,0), angle = Angle(0,0,-90), size = Vector(1, 1, 1), attachment = "optic"},
		["kk_ins2_cstm_eotechxps"] = {model = "models/weapons/attachments/w_cw_kk_ins2_cstm_eotechxps.mdl", pos = Vector(9,-0.3,34.4), angle = Angle(-90,180,90), size = Vector(1, 1, 1), attachment = "optic"},
	}

	SWEP.IronsightPos = Vector(-2.8542, -2, 0.8828)
	SWEP.IronsightAng = Vector(2, 0, 0)

	SWEP.M203Pos = Vector(-0.5168, -2, 1.149)
	SWEP.M203Ang = Vector(0.593, -0.0025, 0)

	SWEP.KKINS2KobraPos = Vector(-2.8542, 0, 0.3292)
	SWEP.KKINS2KobraAng = Vector()

	SWEP.KKINS2EoTechPos = Vector(-2.8542, -1, 0.5707)
	SWEP.KKINS2EoTechAng = Vector()

	SWEP.KKINS2AimpointPos = Vector(-2.8542, -1, 0.5751)
	SWEP.KKINS2AimpointAng = Vector()

	SWEP.KKINS2ElcanPos = Vector(-2.8542, -1, 0.5389)
	SWEP.KKINS2ElcanAng = Vector()

	SWEP.KKINS2PO4Pos = Vector(-2.7742, -1, 0.7473)
	SWEP.KKINS2PO4Ang = Vector()

	SWEP.KKINS2MagnifierPos = Vector(-2.8542, -1.5, 0.5722)
	SWEP.KKINS2MagnifierAng = Vector()

	SWEP.KKINS2CSTMCMorePos = Vector(-2.8542, -1, 0.5952)
	SWEP.KKINS2CSTMCMoreAng = Vector()

	SWEP.KKINS2CSTMBarskaPos = Vector(-2.8542, -1, 0.5623)
	SWEP.KKINS2CSTMBarskaAng = Vector()

	SWEP.KKINS2CSTMMicroT1Pos = Vector(-2.8542, -1, 0.5425)
	SWEP.KKINS2CSTMMicroT1Ang = Vector()

	SWEP.KKINS2CSTMEoTechXPSPos = Vector(-2.8542, -1, 0.6067)
	SWEP.KKINS2CSTMEoTechXPSAng = Vector()

	SWEP.KKINS2CSTMCompM4SPos = Vector(-2.8542, -1, 0.5751)
	SWEP.KKINS2CSTMCompM4SAng = Vector()

	SWEP.KKINS2CSTMACOGPos = Vector(-2.8542, -2, 0.5389)
...
SWEP.ViewModel		= "models/weapons/ethereal/v_l85a2.mdl"
SWEP.WorldModel		= "models/weapons/ethereal/w_l85a2.mdl"

SWEP.WMPos = Vector(5.219, 1.054, -0.893)
...
SWEP.FireSound = "CW_KK_INS2_L85A2_FIRE"
SWEP.FireSoundSuppressed = "CW_KK_INS2_L85A2_FIRE_SUPPRESSED"
SWEP.Recoil = 0.9975
