...
CustomizableWeaponry:registerAmmo(".45 ACP AP", ".45 ACP AP", 9, 43)
CustomizableWeaponry:registerAmmo(".45 ACP MG", ".45 ACP MG", 9, 44)
...
SWEP.WMPos = Vector(4.509, 1.323, -1.616)
