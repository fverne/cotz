...
if CLIENT then
	...
	SWEP.AttachmentModelsVM = {
		["kk_ins2_optic_iron"] = {model = "models/weapons/upgrades/a_carryhandle_m4.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, active = true},
	...
	SWEP.AttachmentModelsWM = {
		["kk_ins2_optic_iron"] = {model = "models/weapons/upgrades/w_flipup3.mdl", pos = Vector(-52.7,25.6,0), angle = Angle(0,0,-90), size = Vector(1, 1, 1), attachment = "modkit", active = true},
...
SWEP.ViewModel		= "models/weapons/ethereal/v_m4a1.mdl"
SWEP.WorldModel		= "models/weapons/ethereal/w_m4a1.mdl"
