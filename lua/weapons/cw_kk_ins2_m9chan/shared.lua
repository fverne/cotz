...
SWEP.ViewModel		= "models/weapons/ethereal/v_beretta.mdl"
SWEP.WorldModel		= "models/weapons/ethereal/w_m9.mdl"
...
SWEP.FireSound = "CW_KK_INS2_M9CHAN_FIRE"
SWEP.FireSoundSuppressed = "CW_KK_INS2_M9CHAN_FIRE_SUPPRESSED"
SWEP.Recoil = 0.77
