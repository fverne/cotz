...
if CLIENT then
	...
	SWEP.AttachmentModelsWM = {
		...
		["kk_ins2_lam"] = {model = "models/weapons/upgrades/w_laser_sec.mdl", pos = Vector(-1.2,9.5,0), angle = Angle(180,0,-90), size = Vector(1, 1, 1), attachment = "laser"},
		["kk_ins2_flashlight"] = {model = "models/weapons/upgrades/w_laser_sec.mdl", pos = Vector(-1.2,9.5,0), angle = Angle(180,0,-90), size = Vector(1, 1, 1), attachment = "laser"},

	}

	SWEP.IronsightPos = Vector(-2.158, -2, 0.5507)
...
SWEP.ViewModel		= "models/weapons/ethereal/v_mac10.mdl"
SWEP.WorldModel		= "models/weapons/ethereal/w_mac10.mdl"
