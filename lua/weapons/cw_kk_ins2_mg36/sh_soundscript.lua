...
SWEP.Sounds = {
	base_ready = {
		...
		{time = 29/28, sound = "CW_KK_INS2_G36C_BOLTBACK"},
		{time = 41/28, sound = "CW_KK_INS2_G36C_BOLTRELEASE"},
	},
	...
	base_reloadempty = {
		...
		{time = 97/30, sound = "CW_KK_INS2_RPK_MAGIN"},
		{time = 122/30, sound = "CW_KK_INS2_RPK_RATTLE"},
		{time = 146/30, sound = "CW_KK_INS2_G36C_BOLTBACK"},
		{time = 153/30, sound = "CW_KK_INS2_G36C_BOLTRELEASE"},
	},
	...
	deployed_reloadempty = {
		...
		{time = 80/30, sound = "CW_KK_INS2_RPK_FETCHMAG"},
		{time = 111/30, sound = "CW_KK_INS2_RPK_MAGIN"},
		{time = 150/30, sound = "CW_KK_INS2_G36C_BOLTBACK"},
		{time = 157/30, sound = "CW_KK_INS2_G36C_BOLTRELEASE"},
