...
if CLIENT then
	...
	SWEP.AttachmentModelsWM = {
		...
		["kk_ins2_suppressor_sec"] = {model = "models/weapons/upgrades/w_sil_sec1.mdl", pos = Vector(-34,-0.1,6.4), angle = Angle(), size = Vector(1, 1, 1), attachment = "silencer"},
	...
	SWEP.IronsightPos = Vector(-2.308, -2, 0.5507)
	SWEP.IronsightAng = Vector(0.3131, 0, 0)

	SWEP.KKINS2KobraPos = Vector(-2.3394, -3, -0.0439)
	SWEP.KKINS2KobraAng = Vector(0, -0.087, 0)

	SWEP.KKINS2EoTechPos = Vector(-2.3252, -3, -0.0142)
	SWEP.KKINS2EoTechAng = Vector(0, -0.087, 0)

	SWEP.KKINS2AimpointPos = Vector(-2.3357, -2, 0.0176)
	SWEP.KKINS2AimpointAng = Vector(0, -0.087, 0)

	SWEP.KKINS2ElcanPos = Vector(-2.3299, -2, -0.2836)
	SWEP.KKINS2ElcanAng = Vector(0, -0.087, 0)

	SWEP.KKINS2PO4Pos = Vector(-2.2805, -3, 0.0772)
	SWEP.KKINS2PO4Ang = Vector(0, -0.087, 0)

	SWEP.KKINS2MagnifierPos = Vector(-2.328, -3, -0.0111)
	SWEP.KKINS2MagnifierAng = Vector(0, -0.087, 0)

	SWEP.KKINS2CSTMMicroT1Pos = Vector(-2.3299, -2, -0.0093)
...
SWEP.ViewModel		= "models/weapons/ethereal/v_mp5a4.mdl"
SWEP.WorldModel		= "models/weapons/ethereal/w_mp5a4.mdl"

SWEP.WMPos = Vector(4.271, 0.867, -1.344)
