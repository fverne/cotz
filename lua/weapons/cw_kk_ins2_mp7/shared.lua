...
CustomizableWeaponry:registerAmmo("4.6x30MM MG", "4.6x30MM MG Ammo", 4.6, 30)
CustomizableWeaponry:registerAmmo("4.6x30MM AP", "4.6x30MM AP Ammo", 4.6, 30)
...
if CLIENT then
	...
	SWEP.AttachmentModelsWM = {
		["kk_ins2_suppressor_sec"] = {model = "models/weapons/upgrades/w_sil_sec1.mdl", pos = Vector(-33.1,6.8,0), angle = Angle(0,0,90), size = Vector(1, 1, 1), attachment = "silencer"},

		["kk_ins2_lam"] = {model = "models/weapons/upgrades/w_laser_sec.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), attachment = "laser"},
	...
	SWEP.IronsightPos = Vector(-2.168, -2, 0.6)
	SWEP.IronsightAng = Vector()

	SWEP.KKINS2KobraPos = Vector(-2.168, -2, 0.05)
	SWEP.KKINS2KobraAng = Vector()

	SWEP.KKINS2EoTechPos = Vector(-2.168, -2, 0.1)
	SWEP.KKINS2EoTechAng = Vector()

	SWEP.KKINS2AimpointPos = Vector(-2.168, -2, 0.1)
	SWEP.KKINS2AimpointAng = Vector()

	SWEP.KKINS2ElcanPos = Vector(-2.168, -2.5, -0.25)
	SWEP.KKINS2ElcanAng = Vector()

	SWEP.KKINS2PO4Pos = Vector(-2.118, -3.75, 0.18)
	SWEP.KKINS2PO4Ang = Vector()

	SWEP.KKINS2MagnifierPos = Vector(-2.148, -3, 0.20)
	SWEP.KKINS2MagnifierAng = Vector(-1.4, 0, 0)

	SWEP.KKINS2CSTMCMorePos = Vector(-2.168, -2, 0.1)
	SWEP.KKINS2CSTMCMoreAng = Vector()

	SWEP.KKINS2CSTMBarskaPos = Vector(-2.168, -2, 0.1)
	SWEP.KKINS2CSTMBarskaAng = Vector()

	SWEP.KKINS2CSTMMicroT1Pos = Vector(-2.168, -2, 0.1)
	SWEP.KKINS2CSTMMicroT1Ang = Vector()

	SWEP.KKINS2CSTMEoTechXPSPos = Vector(-2.168, -2, 0.1)
	SWEP.KKINS2CSTMEoTechXPSAng = Vector()

	SWEP.KKINS2CSTMCompM4SPos = Vector(-2.168, -2, 0.1)
	SWEP.KKINS2CSTMCompM4SAng = Vector()

	SWEP.KKINS2CSTMACOGPos = Vector(-2.168, -2.5, -0.2)
...
SWEP.ViewModel		= "models/weapons/ethereal/v_mp7.mdl"
SWEP.WorldModel		= "models/weapons/ethereal/w_mp7.mdl"

SWEP.WMPos = Vector(3.871, 0.967, -1.344)
