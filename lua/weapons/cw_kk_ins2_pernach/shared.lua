...
if CLIENT then
	...
	SWEP.AttachmentModelsVM = {
		["kk_ins2_optic_sterling"] = {model = "models/weapons/ethereal/pernach_upgrades/a_standard_sterling.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, active = true},
		["kk_ins2_optic_rail"] = {model = "models/weapons/ethereal/pernach_upgrades/a_modkit_sterling.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},

		["kk_ins2_suppressor_sterling"] = {model = "models/weapons/ethereal/pernach_upgrades/a_suppressor_sterling.mdl", pos = Vector(), angle = Angle(0, 90, 0), size = Vector(1, 1, 1), merge = true},

		["kk_ins2_lam"] = {model = "models/weapons/ethereal/pernach_upgrades/a_laser_sterling.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},
		["kk_ins2_flashlight"] = {model = "models/weapons/ethereal/pernach_upgrades/a_flashlight_sterling.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},
	...
	SWEP.AttachmentModelsWM = {
		["kk_ins2_optic_sterling"] = {model = "models/weapons/ethereal/pernach_upgrades/w_standard_sterling.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, active = true},
		["kk_ins2_optic_rail"] = {model = "models/weapons/ethereal/pernach_upgrades/w_modkit_sterling.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},

		["kk_ins2_suppressor_sterling"] = {model = "models/weapons/ethereal/pernach_upgrades/w_sil_sterling.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},
	...
	SWEP.IronsightPos = Vector(-1.8585, -1, 0.378)
	SWEP.IronsightAng = Vector()

	SWEP.KKINS2KobraPos = Vector(-1.8805, -1, -0.808)
	SWEP.KKINS2KobraAng = Vector()

	SWEP.KKINS2EoTechPos = Vector(-1.8805, -1, -0.758)
	SWEP.KKINS2EoTechAng = Vector()

	SWEP.KKINS2AimpointPos = Vector(-1.8805, -1, -0.758)
	SWEP.KKINS2AimpointAng = Vector()

	SWEP.KKINS2MagnifierPos = Vector(-1.8805, -5.5, -0.768)
	SWEP.KKINS2MagnifierAng = Vector()
	
	SWEP.KKINS2CSTMCMorePos = Vector(-1.8805, -1, -0.758)
	SWEP.KKINS2CSTMCMoreAng = Vector()

	SWEP.KKINS2CSTMBarskaPos = Vector(-1.8805, -1, -0.758)
	SWEP.KKINS2CSTMBarskaAng = Vector()

	SWEP.KKINS2CSTMMicroT1Pos = Vector(-1.8805, -1, -0.758)
	SWEP.KKINS2CSTMMicroT1Ang = Vector()

	SWEP.KKINS2CSTMEoTechXPSPos = Vector(-1.8805, -1, -0.758)
	SWEP.KKINS2CSTMEoTechXPSAng = Vector()

	SWEP.KKINS2CSTMCompM4SPos = Vector(-1.8805, -1, -0.758)
	SWEP.KKINS2CSTMCompM4SAng = Vector()

	SWEP.KKINS2CSTMACOGPos = Vector(-1.8805, -1, -0.758)
...
SWEP.Attachments = {
	{header = "Sight", offset = {300, -600}, atts = {"kk_ins2_kobra", "kk_ins2_eotech", "kk_ins2_aimpoint", "kk_ins2_cstm_cmore", "kk_ins2_cstm_barska", "kk_ins2_cstm_microt1", "kk_ins2_cstm_eotechxps", "kk_ins2_cstm_compm4s"}},
	...
	{header = "Caliber", offset = {-800, 350}, atts = {"am_cal_9x19"}},
	{header = "Magazine", offset = {200, 0}, atts = {"fn_mag9"}},
	...
	["+reload"] = {header = "Ammo", offset = {0, 400}, atts = {"am_zoneloaded", "am_matchgrade"}}
}
...
SWEP.ViewModel		= "models/weapons/ethereal/v_pernach.mdl"
SWEP.WorldModel		= "models/weapons/ethereal/w_pernach.mdl"

SWEP.WMPos = Vector(1.5, 1.067, -1.3)
