...
if CLIENT then
	...
	SWEP.AttachmentModelsVM = {
		...
		["kk_ins2_lam"] = {model = "models/weapons/upgrades/a_laser_band.mdl", pos = Vector(0,0,1), angle = Angle(), size = Vector(1, 1, 1), attachment = "Laser"},
		["kk_ins2_flashlight"] = {model = "models/weapons/upgrades/a_flashlight_band.mdl", pos = Vector(0,0,1), angle = Angle(), size = Vector(1, 1, 1), attachment = "Laser"},
		["kk_ins2_anpeq15"] = {model = "models/weapons/attachments/v_cw_kk_ins2_cstm_anpeq_band.mdl", pos = Vector(0,0,1), angle = Angle(), size = Vector(1, 1, 1), attachment = "Laser"},
	...
	SWEP.AttachmentModelsWM = {
		...
		["kk_ins2_suppressor_sec"] = {model = "models/weapons/upgrades/w_sil_sec2.mdl", pos = Vector(-35.1,-4), angle = Angle(0,0,-90), size = Vector(1, 1, 1), attachment = "silencer"},

		["kk_ins2_lam"] = {model = "models/weapons/upgrades/w_laser_ins.mdl", pos = Vector(-3,8.9,-0.65), angle = Angle(0,180,90), size = Vector(1, 1, 1), attachment = "laser"},
		["kk_ins2_flashlight"] = {model = "models/weapons/upgrades/w_laser_ins.mdl", pos = Vector(-3,8.9,-0.65), angle = Angle(0,180,90), size = Vector(1, 1, 1), attachment = "laser"},
	...
	SWEP.IronsightPos = Vector(-2.499, -3, 0.9835)
	SWEP.IronsightAng = Vector(-1.1,-0.051,0)

	SWEP.KKINS2KobraPos = Vector(-2.499, -2, 0.5436)
	SWEP.KKINS2KobraAng = Vector()

	SWEP.KKINS2EoTechPos = Vector(-2.499, -2, 0.5236)
	SWEP.KKINS2EoTechAng = Vector()

	SWEP.KKINS2AimpointPos = Vector(-2.499, -2, 0.5597)
	SWEP.KKINS2AimpointAng = Vector()

	SWEP.KKINS2ElcanPos = Vector(-2.499, -1, 0.4252)
	SWEP.KKINS2ElcanAng = Vector()

	SWEP.KKINS2PO4Pos = Vector(-2.429, -2, 0.9219)
	SWEP.KKINS2PO4Ang = Vector()

	SWEP.KKINS2MagnifierPos = Vector(-2.499, -2, 0.8475)
	SWEP.KKINS2MagnifierAng = Vector()

	SWEP.KKINS2CSTMEoTechXPSPos = Vector(-2.499, -2, 0.7597)
	SWEP.KKINS2CSTMEoTechXPSAng = Vector()
	
	SWEP.KKINS2CSTMPGO7Pos = Vector(-0.8964, -3, -0.5)
	SWEP.KKINS2CSTMPGO7Ang = Vector()

	SWEP.KKINS2CSTMACOGPos = Vector(-2.499, -2, 0.5236)
	SWEP.KKINS2CSTMACOGAng = Vector()

	SWEP.KKINS2CSTMCMorePos = Vector(-2.489, -2, 0.5236)
	SWEP.KKINS2CSTMCMoreAng = Vector()

	SWEP.KKINS2CSTMBarskaPos = Vector(-2.499, -2, 0.5236)
	SWEP.KKINS2CSTMBarskaAng = Vector()

	SWEP.KKINS2CSTMEoTechXPSPos = Vector(-2.499, -2, 0.5236)
	SWEP.KKINS2CSTMEoTechXPSAng = Vector()

	SWEP.KKINS2CSTMCompM4SPos = Vector(-2.499, -2, 0.5236)
...
SWEP.Attachments = {
	{header = "Sight", offset = {400, -450}, atts = {"kk_ins2_eotech", "kk_ins2_elcan", "kk_ins2_po4", "kk_ins2_cstm_barska", "kk_ins2_cstm_acog"}},
...
SWEP.ViewModel		= "models/weapons/ethereal/v_scarh.mdl"
SWEP.WorldModel		= "models/weapons/ethereal/w_scarh.mdl"

SWEP.WMPos = Vector(4.018, 0.711, -1.243)
...
SWEP.FireSound = "CW_KK_INS2_SCARH_FIRE"
