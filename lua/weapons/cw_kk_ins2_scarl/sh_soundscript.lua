...
SWEP.Sounds = {
	...
	base_ready = {
		{time = 0, sound = "CW_KK_INS2_UNIVERSAL_DRAW"},
		{time = 17/30, sound = "CW_JK_INS2_SCAR_BOLT"},
	},
	...
	base_reload = {
		...
		{time = 17/30, sound = "CW_KK_INS2_SCAR_MAGOUT"},
		{time = 64/30, sound = "CW_KK_INS2_SCAR_MAGIN"},
		{time = 84/30, sound = "CW_JK_INS2_SCAR_HIT"},
	},
	...
	base_reloadempty = {
		...
		{time = 17/30, sound = "CW_KK_INS2_SCAR_MAGOUT"},
		{time = 64/30, sound = "CW_KK_INS2_SCAR_MAGIN"},
		{time = 86/30, sound = "CW_JK_INS2_SCAR_HIT"},
