...
if CLIENT then
	...
	SWEP.BackupSights = { // GG
		["kk_ins2_elcan"] = {
			Vector(-2.0055, -1.253, -1.6968),
			Vector(-0.3957, 0.1717, 0)
		},
	}
	...
	SWEP.AttachmentModelsWM = {
		...
		["kk_ins2_vertgrip"] = {model = "models/weapons/upgrades/w_foregrip_sec2.mdl", pos = Vector(0,-1.1,0), angle = Angle(0,0,-90), size = Vector(1, 1, 1), attachment = "foregrip"},
	...
	SWEP.IronsightPos = Vector(-2.0319, -2.3982, 0.0183)
	SWEP.IronsightAng = Vector(0, 0.03, 0)
	
	SWEP.KKINS2KobraPos = Vector(-2, -3.0962, -0.5916)
	SWEP.KKINS2KobraAng = Vector(0,0.2,0)

	SWEP.KKINS2EoTechPos = Vector(-2, -1.9935, -0.5082)
	SWEP.KKINS2EoTechAng = Vector(0,0.2,0)

	SWEP.KKINS2AimpointPos = Vector(-2, -2.6178, -0.5235)
	SWEP.KKINS2AimpointAng = Vector(0,0.2,0)

	SWEP.KKINS2ElcanPos = Vector(-2.0222, -3.9824, -0.7851)
	SWEP.KKINS2ElcanAng = Vector(0,0.2,0)

	SWEP.KKINS2PO4Pos = Vector(-1.9693, -3.5, -0.4246)
	SWEP.KKINS2PO4Ang = Vector(0,0.2,0)

	SWEP.KKINS2MagnifierPos = Vector(-2.0204, -3, -0.5068)
	SWEP.KKINS2MagnifierAng = Vector(-0.1, 0.2, 0)
	
	SWEP.KKINS2CSTMCMorePos = Vector(-2, -2, -0.5)
	SWEP.KKINS2CSTMCMoreAng = Vector(0,0.2,0)	

	SWEP.KKINS2CSTMBarskaPos = Vector(-2, -2, -0.5)
	SWEP.KKINS2CSTMBarskaAng = Vector(0,0.2,0)	
	
	SWEP.KKINS2CSTMMicroT1Pos = Vector(-2, -2, -0.5)
	SWEP.KKINS2CSTMMicroT1Ang = Vector(0,0.2,0)	

	SWEP.KKINS2CSTMACOGPos = Vector(-2, -3.5, -0.78)
	SWEP.KKINS2CSTMACOGAng = Vector(0,0.2,0)	
	
	SWEP.KKINS2CSTMEoTechXPSPos = Vector(-2, -2, -0.45)
	SWEP.KKINS2CSTMEoTechXPSAng = Vector(0,0.2,0)
...
SWEP.ViewModel		= "models/weapons/ethereal/v_sg5511.mdl"
SWEP.WorldModel		= "models/weapons/ethereal/w_sg5511.mdl"

SWEP.WMPos = Vector(4.072, 1.024, -0.837)
...
SWEP.FireDelay = 0.08
SWEP.FireSound = "CW_KK_INS2_SG551_FIRE"
SWEP.FireSoundSuppressed = "CW_KK_INS2_SG551_FIRE_SUPPRESSED"
