...
if CLIENT then
	...
	SWEP.AttachmentModelsVM = {
		...
		["std_mag"] = {model = "models/weapons/sg552/a_sig_mag.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, active = true}, 
	...
	SWEP.KKINS2KobraPos = Vector(-2.345, -2, 0.13)
	SWEP.KKINS2KobraAng = Vector(0,0.2,0)

	SWEP.KKINS2EoTechPos = Vector(-2.345, -2, 0)
	SWEP.KKINS2EoTechAng = Vector(0,0.2,0)

	SWEP.KKINS2AimpointPos = Vector(-2.345, -2, 0.18)
	SWEP.KKINS2AimpointAng = Vector(0,0.2,0)

	SWEP.KKINS2ElcanPos = Vector(-2.325, -3, -0.15)
	SWEP.KKINS2ElcanAng = Vector(0,0.2,0)

	SWEP.KKINS2PO4Pos = Vector(-2.285, -3, 0.276)
	SWEP.KKINS2PO4Ang = Vector(0,0.2,0)

	SWEP.KKINS2MagnifierPos = Vector(-2.335, -2, 0.175)
	SWEP.KKINS2MagnifierAng = Vector(0,0.2,0)
	
	SWEP.KKINS2CSTMCMorePos = Vector(-2.345, -2, 0.165)
	SWEP.KKINS2CSTMCMoreAng = Vector(0,0.2,0)	

	SWEP.KKINS2CSTMBarskaPos = Vector(-2.345, -2, -0.08)
	SWEP.KKINS2CSTMBarskaAng = Vector(0,0.2,0)	
	
	SWEP.KKINS2CSTMMicroT1Pos = Vector(-2.345, -2, 0.18)
	SWEP.KKINS2CSTMMicroT1Ang = Vector(0,0.2,0)	
	
	SWEP.KKINS2CSTMCompM4SPos = Vector(-2.345, -2, 0.18)
	SWEP.KKINS2CSTMCompM4SAng = Vector(0,0.2,0)

	SWEP.KKINS2CSTMACOGPos = Vector(-2.3625, -2, -0.155)
	SWEP.KKINS2CSTMACOGAng = Vector(0,0.2,0)	
	
	SWEP.KKINS2CSTMEoTechXPSPos = Vector(-2.345, -2, 0.15)
...
SWEP.ViewModel		= "models/weapons/ethereal/sg552/v_sg552.mdl"
SWEP.WorldModel		= "models/weapons/ethereal/sg552/w_sg552.mdl"

SWEP.WMPos = Vector(4.518, 1.011, -0.943)
...
SWEP.FireSound = "CW_KK_INS2_SG552_FIRE"
SWEP.FireSoundSuppressed = "CW_KK_INS2_SG552_FIRE_SUPPRESSED"
SWEP.Recoil = 1.05
