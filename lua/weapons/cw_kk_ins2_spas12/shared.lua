...
if CLIENT then
	...
	SWEP.IronsightPos = Vector(-2.004, -1, 0.72)
	SWEP.IronsightAng = Vector(0, 0.06, 0)

	SWEP.KKINS2KobraPos = Vector(-2.0135, -1, -0.3049)
	SWEP.KKINS2KobraAng = Vector()

	SWEP.KKINS2EoTechPos = Vector(-2.0188, -1, -0.147)
	SWEP.KKINS2EoTechAng = Vector()

	SWEP.KKINS2AimpointPos = Vector(-2.004, -1, -0.185)
	SWEP.KKINS2AimpointAng = Vector()

	SWEP.KKINS2MagnifierPos = Vector(-2.004, -1, -0.215)
	...
	SWEP.KKINS2CSTMCMorePos = Vector(-2.0188, -1, -0.187)
	SWEP.KKINS2CSTMCMoreAng = Vector()
	
	SWEP.KKINS2CSTMMicroT1Pos = Vector(-2.0188, -1, -0.187)
	SWEP.KKINS2CSTMMicroT1Ang = Vector()

	SWEP.KKINS2CSTMBarskaPos = Vector(-2.0188, -1, -0.187)
	SWEP.KKINS2CSTMBarskaAng = Vector()

	SWEP.KKINS2CSTMEoTechXPSPos = Vector(-2.0188, -1, -0.187)
	SWEP.KKINS2CSTMEoTechXPSAng = Vector()

	SWEP.KKINS2CSTMCompM4SPos = Vector(-2.0188, -1, -0.187)
...
SWEP.ViewModel		= "models/weapons/ethereal/v_spas12.mdl"
SWEP.WorldModel		= "models/weapons/ethereal/w_spas12.mdl"

SWEP.WMPos = Vector(4.763, 0.435, -2.945)
