...
if CLIENT then
	...
	SWEP.AttachmentModelsWM = {
		...
		["kk_ins2_lam"] = {model = "models/weapons/upgrades/w_laser_sec.mdl", pos = Vector(1,8.4,0.13), angle = Angle(0, 180, 90), size = Vector(1, 1, 1), attachment = "laser"},
		["kk_ins2_flashlight"] = {model = "models/weapons/upgrades/w_laser_sec.mdl", pos = Vector(1,8.4,0.13), angle = Angle(0, 180, 90), size = Vector(1, 1, 1), attachment = "laser"},
	}

	SWEP.IronsightPos = Vector(-1.859, 0, 0)
...
SWEP.ViewModel		= "models/weapons/ethereal/v_usp45.mdl"
SWEP.WorldModel		= "models/weapons/ethereal/w_usp45.mdl"
...
SWEP.FireDelay = 0.1
SWEP.FireSound = "CW_KK_INS2_USP45_FIRE"
SWEP.FireSoundSuppressed = "CW_KK_INS2_USP45_FIRE_SUPPRESSED"
SWEP.Recoil = 1
