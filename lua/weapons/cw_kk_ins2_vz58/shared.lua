...
if CLIENT then
	...
	SWEP.AttachmentModelsVM = {
		...
		["handguardStandard"] = {model = "models/weapons/ethereal/vz58_upgrades/a_standard_akm.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, active = true},

		["kk_ins2_pbs1"] = {model = "models/weapons/upgrades/a_suppressor_ak.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},

		["kk_ins2_vertgrip"] = {model = "models/weapons/ethereal/vz58_upgrades/a_woodgrips_akm.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},
	...
	SWEP.AttachmentModelsWM = {
		...
		["kk_ins2_pbs1"] = {model = "models/weapons/upgrades/w_sil_ins1.mdl", pos = Vector(-34,0.2,11.89), angle = Angle(), size = Vector(1, 1, 1), attachment = "silencer"},

		["kk_ins2_vertgrip"] = {model = "models/weapons/upgrades/w_foregrip_sec1.mdl", pos = Vector(0,-0.5,0), angle = Angle(0,0,-90), size = Vector(1, 1, 1), attachment = "gl"},
...
SWEP.Attachments = {
	...
	{header = "Caliber", offset = {-800, 350}, atts = {"am_cal_556x45", "am_cal_545x39"}},
...
SWEP.ViewModel		= "models/weapons/ethereal/v_vz58.mdl"
SWEP.WorldModel		= "models/weapons/ethereal/w_vz58.mdl"

SWEP.WMPos = Vector(4.266, 0.96, -1.255)
...
SWEP.FireSound = "CW_KK_INS2_VZ58_FIRE"
SWEP.FireSoundSuppressed = "CW_KK_INS2_VZ58_FIRE_SUPPRESSED"
SWEP.Recoil = 1.32
